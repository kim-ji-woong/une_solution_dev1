...
namespace BusanSensorServer
{
    public class Logger
    {
        ...
        public int LogLifeDays
        {
            get { return m_nLogLifeDays; }
            set { m_nLogLifeDays = value; }
        }
        ...
        public void Write(string strLog)
        {
            ...
            string strFilePath = m_strLogFolder + string.Format("\\{3}_{0}{1:00}{2:00}.log", dtNow.Year, dtNow.Month,
                dtNow.Day, m_strLogTag);
            ...
            try
            {
                ...
                string strTime = string.Format("{0}-{1:00}-{2:00} {3:00}:{4:00}:{5:00}", dtNow.Year, dtNow.Month,
