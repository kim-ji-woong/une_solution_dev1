...
{
    public class EquipmentParent : Table
    {
        public enum Fields { eqpmn_parnts_sn, eqp_zone_sn, eqpmn_no, eqpmn_idntfr, eqpmn_name, model_name, makr_name, stndrd, ip, lc, exchng_tm, eqpmn_memo };
        public enum WriteFields { eqp_zone_sn, eqpmn_no, eqpmn_idntfr, eqpmn_name, model_name, makr_name, stndrd, ip, lc, exchng_tm, eqpmn_memo };
        ...
        public static string TableName { get { return "fa_eqpmn_parnts"; } }
        ...
        public void FromCopy(EquipmentParent obj)
        {
