export default class JsonManager{
    ...
    static makeRequestDownloadBuilding(buildingNo, siteNo) {
        const json = {
    ...
    static makeRequestDownloadBuildingGroup(buildingGroupNo, siteNo) {
        const json = {
    ...
    static makeRequestSettingList(siteNo, requestDatas) {
        const json = {
            "siteNo": siteNo,
            "settingDatas": JsonManager.getSettingDataList(requestDatas)
        };

        return JSON.stringify(json);
    }

    static getSettingDataList(requestDatas) {
        const datas = [];
