...
export class CctvSlaveManager {
        ...
        if (sensorNo) {
            ...
            if (masterPoi) {
                ...
                if (masterSensorNo === sensorNo) {
                    ...
                    return CctvSlaveManager.eventType.clickMasterPoi;
                }
                else {
                    if (CctvSlaveManager._isSlavePoi(cctvMappingManager, masterSensorNo, sensorNo)) {
                        ...
                        return CctvSlaveManager.eventType.clickSlavePoi;
                    }
                        ...
                        return CctvSlaveManager.eventType.addSlavePoi;
                    }
                    else {
                        ...
                        return CctvSlaveManager.eventType.newMasterPoi;
                    }
                }
            }
            else {
    ...
    static _removeFromSlave(_3dMaster, cctvMappingManager, masterSensorNo, sensorNo, masterZoneNo) {
        ...
        for (const cctv of cctvs) {
            if (cctvNos === "") {
                cctvNos = cctv.sensor_sn.toString();
            }
            else {
                cctvNos += ", " + cctv.sensor_sn.toString();
            }
    ...
    static _getMasterPoi(poiManager) {
        if (poiManager.masterPoi) {
            return poiManager.masterPoi;
        }
