...
class ComponentProperties extends Component {
    ...
    getComponentProperty() {
        if (SectionData.isEndpointType(this.props.sectionData.component.compn_code)) {
        ...
        else if (SectionData.isProcessType(this.props.sectionData.component.compn_code)) {
            return <ProcessProperty sectionData={this.props.sectionData} teamAllTreeDatas={this.props.sopData.teamAllTreeDatas} actionStep={this.props.actionStep} onApplyComponentProperty={this.props.onApplyComponentProperty} onClickCancel={this.onClickCancel} showConfirmDialog={this.props.showConfirmDialog} sopData={this.props.sopData} />
        }
        else if (SectionData.isAnnotationType(this.props.sectionData.component.compn_code)) {
        ...
        else if (SectionData.isDecisionType(this.props.sectionData.component.compn_code)) {
        ...
        else if (SectionData.isTransmissionType(this.props.sectionData.component.compn_code)) {
            return <InternalProperty sectionData={this.props.sectionData} teamAllTreeDatas={this.props.sopData.teamAllTreeDatas} actionStep={this.props.actionStep} onApplyComponentProperty={this.props.onApplyComponentProperty} onClickCancel={this.onClickCancel} showConfirmDialog={this.props.showConfirmDialog} sopData={this.props.sopData} />
        }
        return <></>
    }
