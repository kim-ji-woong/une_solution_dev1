			    ...
			    <SOPManagerBodyMainComponent>
					<div className={'sopProcessLeft'} ref={this.refSpLft}>
						<div className={'scrollbarOuter'}>
							<div className={'sopAcdn'}>
								<dt ref={this.refDTActionStep} className={cascadingActionStep} onClick={(event) => this.onClickDt(SopManagerResource.ID.cascadingMenu.actionStep, !this.props.showCascading.actionStep)}>
									{SopManagerResource.ID.cascadingMenu.actionStep}
									<Icon.Arrow size="sm" direction={this.props.showCascading.actionStep ? "top" : "bottom"} />
								</dt>
								...
								<dt className={cascadingAddComponent} onClick={(event) => this.onClickDt(SopManagerResource.ID.cascadingMenu.addComponent, !this.props.showCascading.addComponent)}>
									{SopManagerResource.ID.cascadingMenu.addComponent}
									<Icon.Arrow size="sm" direction={this.props.showCascading.addComponent ? "top" : "bottom"} />
								</dt>
								...
								<dt className={cascadingSpecialCharacter} onClick={(event) => this.onClickDt(SopManagerResource.ID.cascadingMenu.specialCharacter, !this.props.showCascading.specialCharacter)}>
									{SopManagerResource.ID.cascadingMenu.specialCharacter}
									<Icon.Arrow size="sm" direction={this.props.showCascading.specialCharacter ? "top" : "bottom"} />
								</dt>
					...
					<div className={'sopCent'}>
						<div className={'spcTop'}>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.copy, null)}>
								<p><Icon.Copy size='xs' />{SopManagerResource.ID.editMenu.copy}</p>
							</li>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.cut, null)}>
								<p><Icon.Cut size='xs' />{SopManagerResource.ID.editMenu.cut}</p>
							</li>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.paste, null)}>
								<p><Icon.Paste size='xs' />{SopManagerResource.ID.editMenu.paste}</p>
							</li>
							<li onClick={() => this.onClickEditMenu(SopManagerResource.ID.editMenu.delete, null)}>
								<p><Icon.Trash size='xs' />{SopManagerResource.ID.editMenu.delete}</p>
							</li>
						</div>
