...
Icon.QuestionCircleIcon = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 33 32" {...props}>
...
Icon.StatusInfoEmergencyBell = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {statusInfoIcons.EmergencyBell?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.StatusInfoDOOR = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {statusInfoIcons.DOOR?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.StatusInfoInvasion = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {statusInfoIcons.Invasion?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.StatusInfoFacility = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 16 16" {...props}>
        {statusInfoIcons.Facility?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.riskNormal = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="69" height="14" viewBox="0 0 69 14" fill="none">
            <path d="M0 3C0 1.34315 1.34315 0 3 0C4.65685 0 6 1.34315 6 3V11C6 12.6569 4.65685 14 3 14C1.34315 14 0 12.6569 0 11V3Z" fill="url(#paint0_linear_3916_27763)"/>
            <path d="M9 3C9 1.34315 10.3431 0 12 0C13.6569 0 15 1.34315 15 3V11C15 12.6569 13.6569 14 12 14C10.3431 14 9 12.6569 9 11V3Z" fill="url(#paint1_linear_3916_27763)"/>
            <path d="M18 3C18 1.34315 19.3431 0 21 0C22.6569 0 24 1.34315 24 3V11C24 12.6569 22.6569 14 21 14C19.3431 14 18 12.6569 18 11V3Z" fill="url(#paint2_linear_3916_27763)"/>
            <path d="M27 3C27 1.34315 28.3431 0 30 0C31.6569 0 33 1.34315 33 3V11C33 12.6569 31.6569 14 30 14C28.3431 14 27 12.6569 27 11V3Z" fill="url(#paint3_linear_3916_27763)"/>
            <path d="M36 3C36 1.34315 37.3431 0 39 0C40.6569 0 42 1.34315 42 3V11C42 12.6569 40.6569 14 39 14C37.3431 14 36 12.6569 36 11V3Z" fill="url(#paint4_linear_3916_27763)"/>
            <path d="M45 3C45 1.34315 46.3431 0 48 0C49.6569 0 51 1.34315 51 3V11C51 12.6569 49.6569 14 48 14C46.3431 14 45 12.6569 45 11V3Z" fill="url(#paint5_linear_3916_27763)"/>
            <path d="M54 3C54 1.34315 55.3431 0 57 0C58.6569 0 60 1.34315 60 3V11C60 12.6569 58.6569 14 57 14C55.3431 14 54 12.6569 54 11V3Z" fill="url(#paint6_linear_3916_27763)"/>
            <path d="M63 3C63 1.34315 64.3431 0 66 0C67.6569 0 69 1.34315 69 3V11C69 12.6569 67.6569 14 66 14C64.3431 14 63 12.6569 63 11V3Z" fill="url(#paint7_linear_3916_27763)"/>
            <defs>
                <linearGradient id="paint0_linear_3916_27763" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#37B44A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint1_linear_3916_27763" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#37B44A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint2_linear_3916_27763" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#37B44A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint3_linear_3916_27763" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#37B44A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint4_linear_3916_27763" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#37B44A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint5_linear_3916_27763" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#37B44A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint6_linear_3916_27763" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#37B44A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint7_linear_3916_27763" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#37B44A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
            </defs>
...
Icon.risk1st = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="69" height="14" viewBox="0 0 69 14" fill="none">
            <path d="M0 3C0 1.34315 1.34315 0 3 0C4.65685 0 6 1.34315 6 3V11C6 12.6569 4.65685 14 3 14C1.34315 14 0 12.6569 0 11V3Z" fill="url(#paint0_linear_417_10979)"/>
            <path d="M9 3C9 1.34315 10.3431 0 12 0C13.6569 0 15 1.34315 15 3V11C15 12.6569 13.6569 14 12 14C10.3431 14 9 12.6569 9 11V3Z" fill="url(#paint1_linear_417_10979)"/>
            <path d="M18 3C18 1.34315 19.3431 0 21 0C22.6569 0 24 1.34315 24 3V11C24 12.6569 22.6569 14 21 14C19.3431 14 18 12.6569 18 11V3Z" fill="url(#paint2_linear_417_10979)"/>
            <path d="M27 3C27 1.34315 28.3431 0 30 0C31.6569 0 33 1.34315 33 3V11C33 12.6569 31.6569 14 30 14C28.3431 14 27 12.6569 27 11V3Z" fill="url(#paint3_linear_417_10979)"/>
            <path d="M36 3C36 1.34315 37.3431 0 39 0C40.6569 0 42 1.34315 42 3V11C42 12.6569 40.6569 14 39 14C37.3431 14 36 12.6569 36 11V3Z" fill="url(#paint4_linear_417_10979)"/>
            <path d="M45 3C45 1.34315 46.3431 0 48 0C49.6569 0 51 1.34315 51 3V11C51 12.6569 49.6569 14 48 14C46.3431 14 45 12.6569 45 11V3Z" fill="url(#paint5_linear_417_10979)"/>
            <path d="M54 3C54 1.34315 55.3431 0 57 0C58.6569 0 60 1.34315 60 3V11C60 12.6569 58.6569 14 57 14C55.3431 14 54 12.6569 54 11V3Z" fill="url(#paint6_linear_417_10979)"/>
            <path d="M63 3C63 1.34315 64.3431 0 66 0C67.6569 0 69 1.34315 69 3V11C69 12.6569 67.6569 14 66 14C64.3431 14 63 12.6569 63 11V3Z" fill="url(#paint7_linear_417_10979)"/>
            <defs>
                <linearGradient id="paint0_linear_417_10979" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#4971FF"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint1_linear_417_10979" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#4971FF"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint2_linear_417_10979" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#4971FF"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint3_linear_417_10979" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#4971FF"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint4_linear_417_10979" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#4971FF"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint5_linear_417_10979" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#4971FF"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint6_linear_417_10979" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#4971FF"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint7_linear_417_10979" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#4971FF"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
            </defs>
...
Icon.risk2nd = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="69" height="14" viewBox="0 0 69 14" fill="none">
            <path d="M0 3C0 1.34315 1.34315 0 3 0C4.65685 0 6 1.34315 6 3V11C6 12.6569 4.65685 14 3 14C1.34315 14 0 12.6569 0 11V3Z" fill="url(#paint0_linear_417_10995)"/>
            <path d="M9 3C9 1.34315 10.3431 0 12 0C13.6569 0 15 1.34315 15 3V11C15 12.6569 13.6569 14 12 14C10.3431 14 9 12.6569 9 11V3Z" fill="url(#paint1_linear_417_10995)"/>
            <path d="M18 3C18 1.34315 19.3431 0 21 0C22.6569 0 24 1.34315 24 3V11C24 12.6569 22.6569 14 21 14C19.3431 14 18 12.6569 18 11V3Z" fill="url(#paint2_linear_417_10995)"/>
            <path d="M27 3C27 1.34315 28.3431 0 30 0C31.6569 0 33 1.34315 33 3V11C33 12.6569 31.6569 14 30 14C28.3431 14 27 12.6569 27 11V3Z" fill="url(#paint3_linear_417_10995)"/>
            <path d="M36 3C36 1.34315 37.3431 0 39 0C40.6569 0 42 1.34315 42 3V11C42 12.6569 40.6569 14 39 14C37.3431 14 36 12.6569 36 11V3Z" fill="url(#paint4_linear_417_10995)"/>
            <path d="M45 3C45 1.34315 46.3431 0 48 0C49.6569 0 51 1.34315 51 3V11C51 12.6569 49.6569 14 48 14C46.3431 14 45 12.6569 45 11V3Z" fill="url(#paint5_linear_417_10995)"/>
            <path d="M54 3C54 1.34315 55.3431 0 57 0C58.6569 0 60 1.34315 60 3V11C60 12.6569 58.6569 14 57 14C55.3431 14 54 12.6569 54 11V3Z" fill="url(#paint6_linear_417_10995)"/>
            <path d="M63 3C63 1.34315 64.3431 0 66 0C67.6569 0 69 1.34315 69 3V11C69 12.6569 67.6569 14 66 14C64.3431 14 63 12.6569 63 11V3Z" fill="url(#paint7_linear_417_10995)"/>
            <defs>
                <linearGradient id="paint0_linear_417_10995" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FFC73A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint1_linear_417_10995" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FFC73A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint2_linear_417_10995" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FFC73A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint3_linear_417_10995" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FFC73A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint4_linear_417_10995" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FFC73A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint5_linear_417_10995" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FFC73A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint6_linear_417_10995" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FFC73A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint7_linear_417_10995" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FFC73A"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
            </defs>
...
Icon.risk3rd = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="69" height="14" viewBox="0 0 69 14" fill="none">
            <path d="M0 3C0 1.34315 1.34315 0 3 0C4.65685 0 6 1.34315 6 3V11C6 12.6569 4.65685 14 3 14C1.34315 14 0 12.6569 0 11V3Z" fill="url(#paint0_linear_417_10999)"/>
            <path d="M9 3C9 1.34315 10.3431 0 12 0C13.6569 0 15 1.34315 15 3V11C15 12.6569 13.6569 14 12 14C10.3431 14 9 12.6569 9 11V3Z" fill="url(#paint1_linear_417_10999)"/>
            <path d="M18 3C18 1.34315 19.3431 0 21 0C22.6569 0 24 1.34315 24 3V11C24 12.6569 22.6569 14 21 14C19.3431 14 18 12.6569 18 11V3Z" fill="url(#paint2_linear_417_10999)"/>
            <path d="M27 3C27 1.34315 28.3431 0 30 0C31.6569 0 33 1.34315 33 3V11C33 12.6569 31.6569 14 30 14C28.3431 14 27 12.6569 27 11V3Z" fill="url(#paint3_linear_417_10999)"/>
            <path d="M36 3C36 1.34315 37.3431 0 39 0C40.6569 0 42 1.34315 42 3V11C42 12.6569 40.6569 14 39 14C37.3431 14 36 12.6569 36 11V3Z" fill="url(#paint4_linear_417_10999)"/>
            <path d="M45 3C45 1.34315 46.3431 0 48 0C49.6569 0 51 1.34315 51 3V11C51 12.6569 49.6569 14 48 14C46.3431 14 45 12.6569 45 11V3Z" fill="url(#paint5_linear_417_10999)"/>
            <path d="M54 3C54 1.34315 55.3431 0 57 0C58.6569 0 60 1.34315 60 3V11C60 12.6569 58.6569 14 57 14C55.3431 14 54 12.6569 54 11V3Z" fill="url(#paint6_linear_417_10999)"/>
            <path d="M63 3C63 1.34315 64.3431 0 66 0C67.6569 0 69 1.34315 69 3V11C69 12.6569 67.6569 14 66 14C64.3431 14 63 12.6569 63 11V3Z" fill="url(#paint7_linear_417_10999)"/>
            <defs>
                <linearGradient id="paint0_linear_417_10999" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FC6B19"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint1_linear_417_10999" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FC6B19"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint2_linear_417_10999" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FC6B19"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint3_linear_417_10999" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FC6B19"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint4_linear_417_10999" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FC6B19"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint5_linear_417_10999" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FC6B19"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint6_linear_417_10999" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FC6B19"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint7_linear_417_10999" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FC6B19"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
            </defs>
...
Icon.risk4th = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="69" height="14" viewBox="0 0 69 14" fill="none">
            <path d="M0 3C0 1.34315 1.34315 0 3 0C4.65685 0 6 1.34315 6 3V11C6 12.6569 4.65685 14 3 14C1.34315 14 0 12.6569 0 11V3Z" fill="url(#paint0_linear_417_11003)"/>
            <path d="M9 3C9 1.34315 10.3431 0 12 0C13.6569 0 15 1.34315 15 3V11C15 12.6569 13.6569 14 12 14C10.3431 14 9 12.6569 9 11V3Z" fill="url(#paint1_linear_417_11003)"/>
            <path d="M18 3C18 1.34315 19.3431 0 21 0C22.6569 0 24 1.34315 24 3V11C24 12.6569 22.6569 14 21 14C19.3431 14 18 12.6569 18 11V3Z" fill="url(#paint2_linear_417_11003)"/>
            <path d="M27 3C27 1.34315 28.3431 0 30 0C31.6569 0 33 1.34315 33 3V11C33 12.6569 31.6569 14 30 14C28.3431 14 27 12.6569 27 11V3Z" fill="url(#paint3_linear_417_11003)"/>
            <path d="M36 3C36 1.34315 37.3431 0 39 0C40.6569 0 42 1.34315 42 3V11C42 12.6569 40.6569 14 39 14C37.3431 14 36 12.6569 36 11V3Z" fill="url(#paint4_linear_417_11003)"/>
            <path d="M45 3C45 1.34315 46.3431 0 48 0C49.6569 0 51 1.34315 51 3V11C51 12.6569 49.6569 14 48 14C46.3431 14 45 12.6569 45 11V3Z" fill="url(#paint5_linear_417_11003)"/>
            <path d="M54 3C54 1.34315 55.3431 0 57 0C58.6569 0 60 1.34315 60 3V11C60 12.6569 58.6569 14 57 14C55.3431 14 54 12.6569 54 11V3Z" fill="url(#paint6_linear_417_11003)"/>
            <path d="M63 3C63 1.34315 64.3431 0 66 0C67.6569 0 69 1.34315 69 3V11C69 12.6569 67.6569 14 66 14C64.3431 14 63 12.6569 63 11V3Z" fill="url(#paint7_linear_417_11003)"/>
            <defs>
                <linearGradient id="paint0_linear_417_11003" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FF3C3C"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint1_linear_417_11003" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FF3C3C"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint2_linear_417_11003" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FF3C3C"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint3_linear_417_11003" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FF3C3C"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint4_linear_417_11003" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FF3C3C"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint5_linear_417_11003" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FF3C3C"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint6_linear_417_11003" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FF3C3C"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
                <linearGradient id="paint7_linear_417_11003" x1="0" y1="7" x2="69" y2="7" gradientUnits="userSpaceOnUse">
                <stop offset="0.5" stopColor="#FF3C3C"/>
                <stop offset="1" stopColor="#DCDCDC"/>
                </linearGradient>
            </defs>
...
Icon.Power = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.156538 15.593C0.516607 12.9303 4.63668 13.485 4.27665 16.1477C3.54959 21.5633 6.16026 27.0412 10.8343 29.8703C16.2145 33.1293 23.3468 32.2626 27.7923 27.8039L26.9192 26.9299C26.5042 26.5138 26.7811 25.7859 27.3626 25.7444L32.3763 25.4192C32.7846 25.3986 33.1372 25.7446 33.1097 26.1604L32.7913 31.1809C32.7498 31.7632 32.0232 32.0407 31.6077 31.6252L30.7278 30.7444C29.3707 32.1104 27.7986 33.2478 26.0813 34.1076C19.8909 37.2209 12.2463 36.444 6.82451 32.1379C1.88744 28.2131 -0.68131 21.8407 0.156538 15.593ZM19.1341 8.41428C19.785 7.49226 21.2734 8.18592 20.9895 9.28147L19.3352 15.5637H22.6243C23.732 15.564 24.3901 16.8469 23.7601 17.7483L16.8626 27.5803C16.2117 28.5025 14.7235 27.8096 15.0071 26.7141L16.6624 20.4319H13.3733C12.2654 20.4319 11.6075 19.1487 12.2376 18.2473L19.1341 8.41428ZM9.9163 1.89279C16.1066 -1.2206 23.7513 -0.444371 29.1731 3.86154C34.1103 7.7863 36.679 14.1597 35.8411 20.4074C35.4806 23.0696 31.3619 22.5143 31.722 19.8518C32.4488 14.4364 29.8382 8.9582 25.1644 6.12912C19.7842 2.87012 12.6519 3.73708 8.20634 8.19553L9.07841 9.06955C9.49388 9.4856 9.21671 10.2135 8.63505 10.2551L3.62236 10.5813C3.21381 10.6021 2.86029 10.2551 2.88798 9.83908L3.20634 4.81858C3.2481 4.2363 3.97551 3.95923 4.39091 4.37522L5.26982 5.25608C6.62697 3.89008 8.1991 2.75263 9.9163 1.89279Z" fill="#FC6B19"/>
        </svg>
    );
};
...
Icon.LeakageCurrent = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
            <path d="M34.7129 33.1299C35.2482 33.1301 35.6825 33.6662 35.6826 34.3262V34.8037C35.6826 35.4639 35.2483 35.9988 34.7129 35.999H0.969727C0.434158 35.999 0 35.4639 0 34.8037V34.3262C0.000150716 33.6661 0.434251 33.13 0.969727 33.1299H34.7129ZM18.4746 22.2627C18.7001 21.8239 19.2162 22.1536 19.1182 22.6748L18.5449 25.665H19.6846C20.0685 25.6651 20.2965 26.2761 20.0781 26.7051L17.6885 31.3848C17.4629 31.8236 16.9465 31.4931 17.0449 30.9717L17.6182 27.9824H16.4785C16.0946 27.9824 15.8666 27.3714 16.085 26.9424L18.4746 22.2627ZM18.5518 0.567383C18.8604 -0.286583 19.8782 -0.143465 20.0225 0.774414L22.1826 14.5498L26.6943 10.8809C27.21 10.4618 27.8973 10.9174 27.8975 11.6787V19.4805L35.166 18.8242C35.8856 18.7594 36.2811 19.8348 35.7676 20.459L29.3828 28.2129L33.3828 31.3115H27.0361L24.9082 29.6641L29.1143 23.2695L24.1162 23.7207V18.6123L19.9248 21.0908L18.5234 12.1514L15.5977 20.2646L10.9648 14.9971L11.2236 23.9453L7.26172 23.7119L10.126 29.3633L8.11914 31.3115H2.18066L5.95215 27.6494L1.74707 23.1279C1.26617 22.6106 1.46962 21.6383 2.09375 21.4727L8.00977 19.9023L5.82129 7.93945C5.6661 7.08854 6.44069 6.44671 7.02148 6.94531L14.0674 13.001L18.5518 0.567383Z" fill="#FFC73A"/>
        </svg>
    );
};
...
Icon.Temperature = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
            <path d="M19.4845 22.081V8.64453H15.8238V22.0805C14.3557 22.771 13.332 24.2523 13.332 25.9825C13.332 28.3695 15.2667 30.3041 17.6537 30.3041C20.0405 30.3041 21.9757 28.3694 21.9757 25.9825C21.9757 24.2529 20.9527 22.7717 19.4845 22.081Z" fill="#E48181"/>
            <path d="M27.1601 11.6955C27.834 11.6955 28.3804 11.1492 28.3804 10.4752C28.3804 9.80135 27.834 9.25494 27.1601 9.25494H24.4961V6.84423C24.4961 6.83411 24.495 6.82458 24.495 6.81445H27.1601C27.834 6.81445 28.3804 6.26804 28.3804 5.59417C28.3804 4.9203 27.834 4.37389 27.1601 4.37389H24.0278C23.0341 1.81844 20.5542 0 17.652 0C13.878 0 10.8076 3.07029 10.8076 6.84423V18.6399C8.77586 20.5358 7.62109 23.1777 7.62109 25.9691C7.62109 31.5003 12.1214 36 17.6525 36C23.1829 36 27.6827 31.5003 27.6827 25.9691C27.6827 23.1771 26.528 20.5352 24.4961 18.6393V16.5765H27.1602C27.8341 16.5765 28.3804 16.0301 28.3804 15.3562C28.3804 14.6823 27.8341 14.1359 27.1602 14.1359H24.4961V11.6954L27.1601 11.6955ZM25.4328 25.9691C25.4328 30.2597 21.9424 33.7501 17.6525 33.7501C13.3619 33.7501 9.87099 30.2598 9.87099 25.9691C9.87099 23.6652 10.8863 21.4921 12.6559 20.0073C12.9103 19.794 13.0576 19.4782 13.0576 19.1457V6.84423C13.0576 4.31075 15.1185 2.24982 17.652 2.24982C20.1854 2.24982 22.2463 4.31075 22.2463 6.84423V19.1451C22.2463 19.4776 22.3935 19.7934 22.648 20.0067C24.4176 21.4915 25.4328 23.6652 25.4328 25.9691Z" fill="#E48181"/>
        </svg>
    );
};
...
Icon.Humidity = () => {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
            <path d="M17.9879 3.19202e-05C17.4953 0.00243192 17.0525 0.302432 16.8668 0.754831C15.6669 3.71883 12.7587 7.61523 10.1139 11.5344C7.47018 15.4536 5 19.3908 5 23.166C5 30.24 10.8333 36 17.9951 36C25.1582 36 31 30.2388 31 23.166C31 19.3908 28.5322 15.4536 25.8861 11.5344C23.2413 7.61523 20.3258 3.71763 19.1271 0.756031C18.9391 0.297632 18.4877 -0.00356808 17.9879 3.19202e-05ZM24.645 21.8724C24.6341 21.2136 25.1679 20.67 25.834 20.6592C26.5061 20.6472 27.0581 21.1752 27.0703 21.8556C27.0703 26.8056 22.9913 30.8292 17.9964 30.8292C17.3266 30.8448 16.771 30.318 16.7576 29.6556C16.7406 28.992 17.2745 28.4436 17.9709 28.4292C21.681 28.4268 24.645 25.5036 24.645 21.8724Z" fill="#6487FA"/>
        </svg>
    );
};

Icon.SortIcon = ({ size = "md", fill, direction }) => {
    return(
        <Svg
            $width={setSize(size)} viewBox="0 0 24 24"
            $style={setDirection(direction)}
        >
            <path id="Vector" fillRule="evenodd" clipRule="evenodd" d="M14 18.175V12C14 11.7167 14.096 11.479 14.288 11.287C14.4793 11.0957 14.7167 11 15 11C15.2833 11 15.521 11.0957 15.713 11.287C15.9043 11.479 16 11.7167 16 12V18.175L17.875 16.3C18.0583 16.1167 18.2873 16.0207 18.562 16.012C18.8373 16.004 19.075 16.1 19.275 16.3C19.475 16.4834 19.5793 16.7124 19.588 16.987C19.596 17.2624 19.5 17.5 19.3 17.7L15.7 21.3C15.6 21.4 15.4917 21.4707 15.375 21.512C15.2583 21.554 15.1333 21.5751 15 21.5751C14.8667 21.5751 14.7417 21.554 14.625 21.512C14.5083 21.4707 14.4 21.4 14.3 21.3L10.7 17.7C10.5167 17.5167 10.425 17.2877 10.425 17.013C10.425 16.7377 10.525 16.5 10.725 16.3C10.925 16.1167 11.1583 16.0207 11.425 16.012C11.6917 16.004 11.925 16.1 12.125 16.3L14 18.175ZM8 5.82505L6.125 7.70005C5.90834 7.91672 5.66667 8.01672 5.4 8.00005C5.13334 7.98338 4.90834 7.88338 4.725 7.70005C4.525 7.50005 4.425 7.26238 4.425 6.98705C4.425 6.71238 4.51667 6.48338 4.7 6.30005L8.3 2.70005C8.4 2.60005 8.50834 2.52905 8.625 2.48705C8.74167 2.44572 8.86667 2.42505 9 2.42505C9.13334 2.42505 9.25834 2.44572 9.375 2.48705C9.49167 2.52905 9.6 2.60005 9.7 2.70005L13.3 6.30005C13.4833 6.48338 13.575 6.71672 13.575 7.00005C13.575 7.28338 13.4833 7.51672 13.3 7.70005C13.1 7.90005 12.8627 8.00005 12.588 8.00005C12.3127 8.00005 12.075 7.90005 11.875 7.70005L10 5.82505V12C10 12.2834 9.90434 12.5207 9.713 12.712C9.521 12.904 9.28334 13 9 13C8.71667 13 8.47934 12.904 8.288 12.712C8.096 12.5207 8 12.2834 8 12V5.82505Z"
            fill={
                    fill
                        ? fill === true
                            ? "currentcolor"
