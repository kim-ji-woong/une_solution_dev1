...
class ArrowTriangle extends Component{
    getTriangle()
    {
        if (!this.props.arrow.triangleVertices ||
            Arrow.isNonePosition(this.props.arrow.endPosition) ||
            !this.props.arrow.endVertex)
        {
            return null;
        }

        if (Arrow.isTopPosition(this.props.arrow.endPosition))
        {
        ...
        else if (Arrow.isBottomPosition(this.props.arrow.endPosition))
        {
            const x1 = this.props.arrow.endVertex.x - Arrow.TriangleWidth / 2;
            const y = this.props.arrow.endVertex.y + Arrow.TriangleHeight;
            const x2 = this.props.arrow.endVertex.x + Arrow.TriangleWidth / 2;
        ...
        else if (Arrow.isLeftPosition(this.props.arrow.endPosition))
        {
        ...
        else// if (Arrow.isRightPosition(this.props.arrow.endPositionType))
        {
            const moveX = 5;
