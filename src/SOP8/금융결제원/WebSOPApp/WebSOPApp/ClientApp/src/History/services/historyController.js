...
export default class HistoryController {
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (result.success) {
                    ...
                    const positionName = {
                        "buildingGroupName": result.buildingGroupName,
                        "buildingName": result.buildingName,
                        "zoneName": result.zoneName
                    }

                    return [result.histories, summary, positionName, result.totalCount, ""];
                }
                else {
    ...
    static async requestPatrolHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, pageRowCount, pageNo = 1, courseName = null, workerName = null) {
        try {
            const jsonData = JsonManager.makeRequestPatrolHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, pageRowCount, pageNo, courseName, workerName);

            const res = await fetch('History/Patrol/RequestPatrolHistory', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestPatrolHistory 호출에 실패하였습니다."];
    }

    static async requestCourseList() {
        try {
            const res = await fetch('History/Patrol/RequestCourseList', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestCourseList 호출에 실패하였습니다."];
    }

    static async downloadExcelAllPatrolHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, courseName, workerName) {
        try {
            const jsonData = JsonManager.makeDownloadExcelAllPatrolHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, courseName, workerName);

            const res = await fetch('History/Patrol/DownloadExcelAllPatrolHistory', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "downloadExcelAllPatrolHistory 호출에 실패하였습니다."];
    }

    static async downloadExcelPartialPatrolHistory(histories) {
        try {
            const jsonData = JsonManager.makeDownloadExcelPartialPatrolHistory(histories);

            const res = await fetch('History/Patrol/DownloadExcelPartialPatrolHistory', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "downloadExcelPartialPatrolHistory 호출에 실패하였습니다."];
    }

    static async requestComingDoors() {
        try {
            const res = await fetch('History/ComingPerson/RequestComingDoors', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestComingDoors 호출에 실패하였습니다."];
    }

    static async requestComingHistories(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, pageRowCount, pageNo = 1, isVisitor = null, doorNo = null, personName = null, isImportArea = false) {
        try {
            const jsonData = JsonManager.makeRequestComingHistories(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, pageRowCount, pageNo, isVisitor, doorNo, personName, isImportArea);

            const res = await fetch('History/ComingPerson/RequestComingHistories', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestComingHistories 호출에 실패하였습니다."];
    }

    static async requestExcelAllComingHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, isVisitor, doorNo, personName, isImportArea) {
        try {
            const jsonData = JsonManager.makeRequestExcelAllComingHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, isVisitor, doorNo, personName, isImportArea);

            const res = await fetch('History/ComingPerson/RequestExcelAllComingHistory', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestExcelAllComingHistory 호출에 실패하였습니다."];
    }

    static async requestExcelPartialComingHistory(histories) {
        try {
            const jsonData = JsonManager.makeRequestExcelPartialComingHistory(histories);

            const res = await fetch('History/ComingPerson/RequestExcelPartialComingHistory', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestExcelPartialComingHistory 호출에 실패하였습니다."];
    }

    // 출입차량 이력 조회
    static async requestParkingHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, pageRowCount, pageNo = 1, cmmtktYn = null, parkngNo = null) {
        try {
            const jsonData = JsonManager.makeRequestParkingHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, pageRowCount, pageNo, cmmtktYn, parkngNo);

            const res = await fetch('History/Parking/RequestParkingHistory', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestParkingHistory 호출에 실패하였습니다."];
    }

    static async requestExcelAllParkingHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, cmmtktYn, parkngNo) {
        try {
            const jsonData = JsonManager.makeRequestExcelAllParkingHistory(beginYear, beginMonth, beginDay, endYear, endMonth, endDay, cmmtktYn, parkngNo);

            const res = await fetch('History/Parking/RequestExcelAllParkingHistory', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestExcelAllParkingHistory 호출에 실패하였습니다."];
    }

    static async requestExcelPartialParkingHistory(histories) {
        try {
            const jsonData = JsonManager.makeRequestExcelPartialParkingHistory(histories);

            const res = await fetch('History/Parking/RequestExcelPartialParkingHistory', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestExcelPartialParkingHistory 호출에 실패하였습니다."];
    }
}