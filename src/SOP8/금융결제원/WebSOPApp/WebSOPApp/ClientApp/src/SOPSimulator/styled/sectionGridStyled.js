...
import check_component from '../../Common/images/check_component.svg';
...
export const SectionGridComponent = styled.div`
    ...
    .doneComponent {
        background-color: ${({ theme }) => theme.colors.primary.p900} !important;
        border: 5px solid ${({ theme }) => theme.colors.primary.p900} !important;
        color: #CECFD2 !important;
    }

    .waitComponent {
        background-color: #384355;
        border: 5px solid #384355;
        color: #CECFD2;
    }
