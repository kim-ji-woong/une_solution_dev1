...
function RegularMemberPage(props) {
    ...
    }, [props.selectedTeam, props.regularMembers, props.memberGridData, displayMembers, search]);

	// 체크된 멤버가 한 명이라도 존재할 때에만 삭제 버튼 활성화
	const visibleChecked = props.selectedTeam
		? getViewRegularMember(props.selectedTeam, searchMember()).some(m => m.checked)
		: false;
