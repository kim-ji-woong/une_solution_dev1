export class SopSimulatorJsonManager {
    ...
    static makeExcuteSOP(smallClassNo, actionStepNo, userNo, position, beginTime, sensorZoneHistoryNo) {
        const json = {
            ...
            "position": position,
            "beginTime": beginTime,//SopSimulatorJsonManager.makeTime(beginTime),
    ...
    static makeSendMessage(actionStepHistoryNo, componentNo, componentType, userNo, useSMS, useEmail, useBroadcast, useSiren, message, receivers, siteNo, subject) {
        const json = {
            "actionStepHistoryNo": actionStepHistoryNo,
            "componentNo": componentNo,
            "componentType": componentType,
