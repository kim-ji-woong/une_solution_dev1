...
export default class SopSimulatorController {
    ...
    static async sendMessage(actionStepHistoryNo, componentNo, componentType, userNo, useSMS, useEmail, useBroadcast, useSiren, message, receivers, siteNo, subject) {
        try {
            const jsonData = SopSimulatorJsonManager.makeSendMessage(actionStepHistoryNo, componentNo, componentType, userNo, useSMS, useEmail, useBroadcast, useSiren, message, receivers, siteNo, subject);
