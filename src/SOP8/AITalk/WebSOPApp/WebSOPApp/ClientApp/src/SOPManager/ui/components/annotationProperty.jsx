...
class AnnotationProperty extends Component {
    ...
    static getDerivedStateFromProps(props, state) {
        ...
        state.instance.refTitle.current.value = state.instance.refTitle.current.text = sectionData.comment.contents;
    ...
    saveSectionData(shouldUpdate) {
        ...
        sectionData.comment.contents = this.refTitle.current.value;
                        ...
                        <div className={'arrowBox'}>
                            ...
                            {/* <div className={"scroll-wrapper " + AnnotationProperty.cssStyles.sprmExTxt + " scrollbar-outer scroll-textarea"} id="pos_relative">
                                ...
                                <span className={'scrollContentAnnotation'}>
                                    <textarea ref={this.refTitle} name="" id="" cols="30" rows="10" className={'sprmExTxt' + " " + 'scrollbarOuter'} defaultValue={this.state.sectionData?.comment?.contents} onChange={this.onChangeText}></textarea>
                                </span>
                            {/* </div> */}
                            {/* </div> */}
                            </div>
    ...
    onApplyComponentProperty = () => {
        const sectionData = { ...this.state.sectionData };
        sectionData.comment.title = this.refText.current.value;
            ...
            <>
                <div className="componentProperties">
                    ...
                    <div className="annotationProperty">
                        ...
                        <textarea ref={this.refText} className="componentText" value={this.state.sectionData.comment.title} onChange={this.onChangeText}/>
                    </div>
                </div>
