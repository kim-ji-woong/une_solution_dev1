    ...
    return (
        <Wrapper $isDisabled={isDisabled}>
            <CheckBox
                ...
                onChange={(e) => {if(!isDisabled) {sopType === 'equipment' ? setChecked(!isChecked) : setChecked(e.target, sopType)}}}
                type="checkbox"
                checked={isChecked || ''}
            />
        </Wrapper>
...
const CheckBox = styled.input`
    ...
    &::before {
        ...
        align-items: center;
        color: ${(props) => props.$leftcolor ?? '#000'} !important;
        font-weight: 700;
        font-size: 12px;
        left: 11px;
    ...
    &::after {
        ...
        left: 5px;
        border-radius: 50%;
        background: ${(props) => props.$circleColor ?? '#000'} !important;
    ...
    &:checked {
        ...
        &::before {
            ...
            color: ${(props) => props.$rightcolor ?? '#fff'} !important;
            left: 0;
        }
