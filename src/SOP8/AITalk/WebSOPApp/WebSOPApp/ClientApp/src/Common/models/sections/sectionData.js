export default class SectionData {
    ...
    static ProcessTypeCode = 200200;
    static DecisionTypeCode = 200201;
    static AnnotationTypeCode = 200202;
    static EndpointTypeCode = 200203;
    static TransmissionTypeCode = 200204;
    ...
    static isProcessType(componentCode) {
        if (componentCode === SectionData.ProcessType || componentCode === SectionData.ProcessTypeCode || componentCode === "process") {
            return true;
        }
    ...
    static isAnnotationType(componentCode) {
        if (componentCode === SectionData.AnnotationType || componentCode === SectionData.AnnotationTypeCode || componentCode === "annotation") {
            return true;
        }
    ...
    static isDecisionType(componentCode) {
        if (componentCode === SectionData.DecisionType || componentCode === SectionData.DecisionTypeCode || componentCode === "decision") {
            return true;
        }
    ...
    static isEndpointType(componentCode) {
        if (componentCode === SectionData.EndpointType || componentCode === SectionData.EndpointTypeCode || componentCode === "endpoint") {
            return true;
        }
    ...
    static isTransmissionType(componentCode) {
        if (componentCode === SectionData.InternalType || componentCode === SectionData.TransmissionTypeCode || componentCode === "internal") {
            return true;
        }
