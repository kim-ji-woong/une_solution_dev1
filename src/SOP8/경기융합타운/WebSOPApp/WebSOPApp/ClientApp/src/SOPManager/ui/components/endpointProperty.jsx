                    ...
                    <div className={'sprStartBox'}>
                        ...
                        <div className={'sprmStend'}>
                            <li>
                                <label>
                                    <span className={'labelInputRadio'}>
                                        <input type="radio" name="sprmStend" className={'labelInput'} id={'sprmStend01'} checked={this.state.sectionData?.isBegin} onChange={() => this.onChange(true)} />
                                    </span>
                                    시작
                                </label>
                            </li>
                            <li>
                                <label>
                                    <span className={'labelInputRadio'}>
                                        <input type="radio" name="sprmStend" className={'labelInput'} id={'sprmStend02'} checked={!this.state.sectionData?.isBegin} onChange={() => this.onChange(false)} />
                                    </span>
                                    종료
                                </label>
                            </li>
