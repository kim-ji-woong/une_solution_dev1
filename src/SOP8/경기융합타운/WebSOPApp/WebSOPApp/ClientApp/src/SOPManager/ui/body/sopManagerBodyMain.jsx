...
class SopManagerBodyMain extends Component {
	...
	onClickMenu(e) {
		...
		if (target.innerText === SopManagerResource.menu.editSOP) {
			this.props.content(SopManagerResource.menu.editSOP, null);
		}
		else if (target.innerText === SopManagerResource.menu.open) {
			this.props.content(SopManagerResource.menu.open, null);
		}
		else if (target.innerText === SopManagerResource.menu.save) {
			this.props.content(SopManagerResource.menu.save, this.props.sopData, true);
		}
			...
			this.props.content(SopManagerResource.menu.saveXML, this.props.sopData);
		}
		else if (target.innerText === SopManagerResource.menu.openXML) {
			this.props.content(SopManagerResource.menu.openXML, null);
		}
		else if (target.innerText === SopManagerResource.menu.newSOP) {
			this.props.content(SopManagerResource.menu.newSOP, null);
		}
		else if (target.innerText === SopManagerResource.menu.delete) {
			this.props.content(SopManagerResource.menu.delete, null);
		}
	}
