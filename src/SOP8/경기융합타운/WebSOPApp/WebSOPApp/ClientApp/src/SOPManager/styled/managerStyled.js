...
export const SopManagerContentComponent = styled.div`
    ...
    .newSOPIcon{
        ...
        width: 44px;
        height: 44px;
        background: url(./../../resource/image/sopManager/newSopIcon.png) center center;
        color: #215336;
        margin-bottom: 4px;
        font-size: 0px;
    }
    ...
    .sopOpenIcon{
        ...
        width: 44px;
        height: 44px;
        background: url(./../../resource/image/sopManager/sopOpenIcon.png) center center;
        color: #215336;
        margin-bottom: 4px;
        font-size: 0px;
    }
    ...
    .sopSaveIcon{
        ...
        width: 44px;
        height: 44px;
        background: ${(props) => props.$disabled === null ? 'url(./../../resource/image/sopManager/sopSaveIcon_disabled.png)' : 'url(./../../resource/image/sopManager/sopSaveIcon.png)'};
        color: #215336;
        margin-bottom: 4px;
        font-size: 0px;
    ...
    .sopDeleteIcon{
        ...
        width: 44px;
        height: 44px;
        background: url(./../../resource/image/sopManager/sopTrashIcon.png) center center;
        color: #215336;
        margin-bottom: 4px;
        font-size: 0px;
    }
    ...
    .sopOpenXMLIcon{
        ...
        width: 44px;
        height: 44px;
        background: url(./../../resource/image/sopManager/openXMLIcon.png) center center;
        color: #215336;
        margin-bottom: 4px;
        font-size: 0px;
    }
    ...
    .sopSaveXMLIcon{
        ...
        width: 44px;
        height: 44px;
        background: ${(props) => props.$disabled === null ? 'url(./../../resource/image/sopManager/saveXMLIcon_disabled.png)' : 'url(./../../resource/image/sopManager/saveXMLIcon.png)'};
        color: #215336;
        margin-bottom: 4px;
        font-size: 0px;
        cursor: ${(props) => props.$disabled === null ? 'default !important' : 'pointer'};
...
export const PanelAreasComponent = styled.div`
    ...
    .sectionPanels > .sectionPanel > .sectionGrid > .sectionGridColumn > .sectionGridCell:hover:before {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
