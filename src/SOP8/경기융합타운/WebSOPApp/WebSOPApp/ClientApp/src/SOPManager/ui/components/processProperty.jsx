						...
						<div className={'tal'}>
							<div className={'scrollWrapper'} id="pos_relative">
								<div className={'scrollContentMission'}>
									<textarea name="" id="" cols="30" rows="10" className={'sprtTxt' + " " + 'scrollbarOuter'} value={mission.missionText} onChange={(event) => this.onMissionTextChange(event, mission)}></textarea>
								</div>
							</div>
						</div>
					</li>
				...
				<div className={'sprContProcess'}>
					...
					<div className={'sprMid'}>
						<div className={'scrollWrapperProcess'}>
							<div className={'scrollContent'}>
								<div className={'sprmContProcess'}>
									<div className={'sprmAcdn'}>
