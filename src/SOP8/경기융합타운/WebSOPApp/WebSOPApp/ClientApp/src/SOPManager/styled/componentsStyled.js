...
export const ProcessPropertyComponent = styled(AnnotationPropertyComponent)`
    ...
    .sprmAcdn dt.on::after {
        background: url(../../SOPManager/image/sopMenuArrowUp.png)no-repeat center bottom;
    }
    .sprmAcdn dd { 
        display: none;
    }
    ...
    .sprmBtn li:first-child a {
        background: #457de9; 
        color: #fff;
    }
    .sprmBtn li:first-child a:hover,
    .sprmBtn li:first-child a:active,
    .sprmBtn li:first-child a:focus {
        background: #213e88;
    }
