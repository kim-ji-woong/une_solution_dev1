...
export const SopSimulatorSBcallComponent = styled.section`
    ...
    .menualListWrap .list li.is-active a:before,
    .menualListWrap .list li a:hover:before{ }
    .menualListWrap.list li.is-active a,
    .menualListWrap .list li a:hover{ } 
    .menualListWrap .list li a:active{ }
    ...
    .boardListWrap .list li{ 
        border-bottom: dashed 1px #2A3344; 
    }
    ...
    .sopArrowIcon{ 
        ...
        width: 10px; 
        height: 10px; 
        background: url('../../SOPSimulator/img/arrowIcon.png')no-repeat center center;
        margin-right: 10px; 
    }
`;


export const ProcessListSBComponent = styled.section`
    float:left; 
    height:calc(100% + 5px); 
    border-radius:4px;
...
export const MissionListSBComponent = styled.section`
    float:left; 
    height:calc(100% + 5px); 
    border-radius:4px; 
    width:calc(50% - 30px);  
...
export const SopSimulatorSBChartComponent = styled.div`
    float:left; 
    height:calc(100% + 5px); 
    border-radius:4px; 
    width:calc(50% + 10px);
