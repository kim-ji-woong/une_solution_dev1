...
function BeginOption(props) {
    ...
    useEffect(() => {
        ...
        $('#sqpRdo01').click(function () {
            $('.sqpSelectBox').css({ background: '#323b4b' });
                    ...
                    <div className={'sqPop'}>
                        ...
                        <div className={'sqpCont'}>
                            ...
                            <div className={'sqpDown'}>
                                ...
                                <ul className={'sqpRdo'}>
                                {/* <li><input type="radio" name="sqpRdo" id="sqpRdo01" onChange={() => onChangeTimeMode(false)} checked={isCurrent} /><label htmlFor="sqpRdo01">현재 시간을 재난발생시간으로 설정</label></li>
                                    <li><input type="radio" name="sqpRdo" id="sqpRdo02" onChange={() => onChangeTimeMode(true)} /><label htmlFor="sqpRdo02">재난발생 시간 입력</label></li> */}
