...
function Decision(props) {
    ...
    const onChangeValue = (e) => {        
        ...
        for (var i = 0; i < arrowValues.length; i++) {
            if (arrowValues[i].arrowID.toString() === e.target.value) {
    ...
    const getArrowValue = () => {
        ...
        for (let i = 0; i < length; i++) {
            ...
            if (props.sectionData.gridColumnIndex.toString() === props.arrows[i].beginCell.parentElement.dataset.index &&
                props.sectionData.gridRowIndex.toString() === props.arrows[i].beginCell.dataset.index) {
                const arrowValue = {
                    arrowID: arrow.id,
    ...
    const getArrowText = () => {
        ...
        for (let i = 0; i < length; i++) {
            ...
            ui.push(<option key={arrow.arrowID} value={arrow.arrowID}>{arrow.arrowText}</option>);
        }
