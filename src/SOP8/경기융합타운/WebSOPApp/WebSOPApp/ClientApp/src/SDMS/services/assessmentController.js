export class AssessmentController {
    ...
    static async LoadScoreByZone(zoneID, siteNo) {
        try {
            const data = {
                "ZoneID": zoneID,
                "SiteNo": siteNo
    ...
    static async LoadAssessmentClass(nSiteNo) {
        try {
            const res = await fetch('SDMS/Assessment/LoadAssessmentClass', {
                ...
                body: JSON.stringify({ "SiteNo": nSiteNo })
            });
    ...
    static async LoadAutoAssessment(nSiteNo) {
        try {
    ...
    static async SetAutoAssessment(siteNo, type, date) {
        try {
            const res = await fetch('SDMS/Assessment/SetAutoAssessment', {
                ...
                body: JSON.stringify({ "SiteNo": siteNo, "Type": type, "Date": date })
            });
