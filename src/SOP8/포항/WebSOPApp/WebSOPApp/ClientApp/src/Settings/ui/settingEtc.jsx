...
function SettingEtc(props) {
    ...
    const onClickInitializeSettings = () => {
        props.showConfirmDialog(ProjectResource.dialogTypes.QUESTION, ['환경설정을 초기화하시겠습니까?'], ['취소', '확인'], doInitializeSettings);
    }
        ...
        <SettingEtcComponent>
            <ul className='contents'>
                ...
                <li className='item margin'>
                    <div>
                        <p>환경설정 초기화 설정</p>
                        <button onClick={() => onClickInitializeSettings()}>시스템 기본값으로 재설정</button>
                    </div>
