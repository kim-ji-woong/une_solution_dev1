                    ...
                    </li>
                    {
                        showPOIviewer &&
                            <li className='poiIcon'>
                                ...
                                <button className={'UI_Section on'} data-title="수위계 CCTV"></button>
                                <button className={'UI_Section on'} data-title="주요도로 CCTV"></button>
                                <button className={'UI_Section on'} data-title="스마트교차로 CCTV"></button>
                                <button className={'UI_Section on'} data-title="스마트횡단보도 CCTV"></button>
...
function DistanceMeasure(props) {
    ...
    const onClickClosePopup = () => {
        props.showConfirmDialog(ProjectResource.dialogTypes.QUESTION, ["거리측정 모드를 종료하시겠습니까?"], ["확인"], doClosePopup);
    }
