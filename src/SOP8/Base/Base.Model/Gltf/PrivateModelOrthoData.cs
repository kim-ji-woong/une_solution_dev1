...
{
    public class PrivateModelOrthoData : Table
	{
		public enum Fields { gltf_model_ortho_data_sn, user_sn, camera_lc_x, camera_lc_y, camera_lc_z, camera_rtate_x, camera_rtate_y, camera_rtate_z, trgt_x, trgt_y, trgt_z, zoom };
		public enum WriteFields { gltf_model_ortho_data_sn, user_sn, camera_lc_x, camera_lc_y, camera_lc_z, camera_rtate_x, camera_rtate_y, camera_rtate_z, trgt_x, trgt_y, trgt_z, zoom };
		...
		public static string TableName { get { return "sdms_gltf_prv_model_ortho_data"; } }
		...
		{
			return string.Format("{0} = {1} and {2} = {3}", Fields.gltf_model_ortho_data_sn, gltf_model_ortho_data_sn, Fields.user_sn, user_sn);
		}
		...
		public void FromCopy(PrivateModelOrthoData obj)
		{
