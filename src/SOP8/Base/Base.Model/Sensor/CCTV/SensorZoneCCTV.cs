...
{
	public class SensorZoneCCTV : Table
	{
		public enum Fields { sensor_zone_sn, cctv_1, cctv_2, cctv_3, cctv_4 };
		public enum WriteFields { sensor_zone_sn, cctv_1, cctv_2, cctv_3, cctv_4 };
		...
		public static string TableName { get { return "fa_sensor_zone_cctv"; } }
		...
		public void FromCopy(SensorZoneCCTV obj)
		{
