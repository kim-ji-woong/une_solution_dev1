...
function SopSimulatorChart(props) {
    ...
    useEffect(() => {
        ...
        if (prevProps.current?.currentSection !== props.currentSection) {
            ...
            // 실행중인 컴포넌트로 자동 화면 이동
            if (props.commonSettings?.UseAutoMoveSOPScreen?.value === 'true' && sectionData) {
    ...
    const showConfirmDialog = () => {
        ...
        if (props.currentSection.component.compn_code === 3 && props.currentSection.endpoint.begin_yn) {
