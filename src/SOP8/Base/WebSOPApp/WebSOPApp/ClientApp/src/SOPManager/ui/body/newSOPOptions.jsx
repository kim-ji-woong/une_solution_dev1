									...
									<div className={'speScr'}>
										<div className={'speIpt'}>
											...
											<span className={'labelInputTextBlack'}>
												<input ref={refNewDisaster} type="text" /* className={bodyStyles.fullText} */ disabled={selectedSubDisasterCategory === null} placeholder={SopManagerResource.ID.placeHolders.newSOP} onChange={() => onChangeDisasterText()} onFocus={() => onChangeDisasterText()} onKeyDown={(e) => activeEnter(e)} />
											</span>
											</li>
										</div>
									</div>
