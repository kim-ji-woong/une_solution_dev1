...
import { activeIcons, defaultIcons, directionIcons } from "./data.Icon";
 ...
 * }
 */
Icon.IconDescription = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
 ...
 * }
 */
Icon.Lock = ({ size = "md", isActive, fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Lock({ isActive })?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
 ...
 * }
 */
Icon.ZoomIn = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.ZoomIn?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
 ...
 * @returns
 */
Icon.IconDoubleArrow = ({ size = "md", direction, fill }) => (
    <Svg
        $width={setSize(size)}
        $style={setDirection(direction)}
        viewBox="0 0 24 24"
    >
        {directionIcons.DoubleArrow?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.Minus = ({ size = 24 }) => {
    return (
        <Svg $width={setSize(size)} viewBox="0 0 24 24">
            <path
                d="M5.14286 13C4.81905 13 4.54743 12.904 4.328 12.712C4.10933 12.5207 4 12.2833 4 12C4 11.7167 4.10933 11.479 4.328 11.287C4.54743 11.0957 4.81905 11 5.14286 11H18.8571C19.181 11 19.4522 11.0957 19.6709 11.287C19.8903 11.479 20 11.7167 20 12C20 12.2833 19.8903 12.5207 19.6709 12.712C19.4522 12.904 19.181 13 18.8571 13H5.14286Z"
                fill="var(--Error_500)"
            />
        </Svg>
    );
 ...
 * @returns
 */
Icon.IconHelp = ({ size = "md", fill, full }) => {
    return (
        <Svg $width={setSize(size)} viewBox="0 0 24 24">
            <path
                d={
...
Icon.IconBuilding = ({ size = 24, fill = "var(--G_100)" }) => {
    return (
        <Svg $width={setSize(size)} viewBox="0 0 24 24" fill="none">
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M7 4C6.73478 4 6.48043 4.10536 6.29289 4.29289C6.10536 4.48043 6 4.73478 6 5V20H18V5C18 4.73478 17.8946 4.48043 17.7071 4.29289C17.5196 4.10536 17.2652 4 17 4H7ZM20 20V5C20 4.20435 19.6839 3.44129 19.1213 2.87868C18.5587 2.31607 17.7956 2 17 2H7C6.20435 2 5.44129 2.31607 4.87868 2.87868C4.31607 3.44129 4 4.20435 4 5V20H3C2.44772 20 2 20.4477 2 21C2 21.5523 2.44772 22 3 22H21C21.5523 22 22 21.5523 22 21C22 20.4477 21.5523 20 21 20H20ZM8 8C8 7.44772 8.44772 7 9 7H10C10.5523 7 11 7.44772 11 8C11 8.55228 10.5523 9 10 9H9C8.44772 9 8 8.55228 8 8ZM13 8C13 7.44772 13.4477 7 14 7H15C15.5523 7 16 7.44772 16 8C16 8.55228 15.5523 9 15 9H14C13.4477 9 13 8.55228 13 8ZM8 12C8 11.4477 8.44772 11 9 11H10C10.5523 11 11 11.4477 11 12C11 12.5523 10.5523 13 10 13H9C8.44772 13 8 12.5523 8 12ZM13 12C13 11.4477 13.4477 11 14 11H15C15.5523 11 16 11.4477 16 12C16 12.5523 15.5523 13 15 13H14C13.4477 13 13 12.5523 13 12ZM8 16C8 15.4477 8.44772 15 9 15H10C10.5523 15 11 15.4477 11 16C11 16.5523 10.5523 17 10 17H9C8.44772 17 8 16.5523 8 16ZM13 16C13 15.4477 13.4477 15 14 15H15C15.5523 15 16 15.4477 16 16C16 16.5523 15.5523 17 15 17H14C13.4477 17 13 16.5523 13 16Z"
                fill={setFill(fill)}
            />
        </Svg>
    ); 
...
Icon.IconAdmin = ({ size = 24, fill = "var(--G_500)" }) => {
    return (
        <Svg $width={setSize(size)} viewBox="0 0 24 24" fill="none">
            <path
...
Icon.EmptyPaper = ({ width = "60", height = "60" }) => {
    return (
        <Svg width={width} height={height} viewBox="0 0 60 60" fill="none">
            <path d="M55.9998 5V48.7859L38.6665 51.2222V7.4363L55.9998 5Z" fill="#D7DEED"/>
            <path d="M21.3335 5V48.7859L38.6668 51.2222V7.4363L21.3335 5Z" fill="#AFB9D2"/>
            <path d="M21.3333 5V48.7859L4 51.2222V7.4363L21.3333 5Z" fill="#D7DEED"/>
            <path d="M38.6667 59.5989C43.985 59.5989 48.2964 55.2876 48.2964 49.9693C48.2964 44.651 43.985 40.3397 38.6667 40.3397C33.3484 40.3397 29.0371 44.651 29.0371 49.9693C29.0371 55.2876 33.3484 59.5989 38.6667 59.5989Z" fill="#DD3232"/>
            <path d="M39.6305 45.6353C39.6305 45.1035 39.1994 44.6723 38.6676 44.6723C38.1357 44.6723 37.7046 45.1035 37.7046 45.6353V51.4131C37.7046 51.9449 38.1357 52.3761 38.6676 52.3761C39.1994 52.3761 39.6305 51.9449 39.6305 51.4131V45.6353Z" fill="white"/>
            <path d="M38.6676 55.748C39.1994 55.748 39.6305 55.3169 39.6305 54.7851C39.6305 54.2532 39.1994 53.8221 38.6676 53.8221C38.1357 53.8221 37.7046 54.2532 37.7046 54.7851C37.7046 55.3169 38.1357 55.748 38.6676 55.748Z" fill="white"/>
        </Svg>
    );
};
...
Icon.PowerIcon = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Power?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.QuestionCircleIcon = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.QuestionCircle?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.InfoCircleIcon = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.InfoCircle?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.ExpandIcon = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Expand?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.DoorIcon = ({ size = "md", fill, isFill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Door({ isFill })?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.DomainIcon = ({ size = "md", fill, isFill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Domain?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconInspection = ({ size = "md", fill, isFill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Inspection?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconData = ({ size = "md", fill, isFill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Data?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconData2 = ({ size = "md", fill, isFill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Data2?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconMinimap = ({ size = "md", fill, isFill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Minimap?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconMonitoringStats = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.MonitoringStats?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconLocationMarker = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.LocationMarker?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconBell = ({ size = "md", fill, isFill = false, ...props }) => {
    return (
        <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
            {isFill ? (
                <>
                    <path
                        d="M4.287 18.712C4.479 18.904 4.71667 19 5 19H19C19.2833 19 19.5207 18.904 19.712 18.712C19.904 18.5207 20 18.2833 20 18C20 17.7167 19.904 17.4793 19.712 17.288C19.5207 17.096 19.2833 17 19 17H18V10C18 8.61667 17.5833 7.38733 16.75 6.312C15.9167 5.23733 14.8333 4.53333 13.5 4.2V3.5C13.5 3.08333 13.354 2.72933 13.062 2.438C12.7707 2.146 12.4167 2 12 2C11.5833 2 11.2293 2.146 10.938 2.438C10.646 2.72933 10.5 3.08333 10.5 3.5V4.2C9.16667 4.53333 8.08333 5.23733 7.25 6.312C6.41667 7.38733 6 8.61667 6 10V17H5C4.71667 17 4.479 17.096 4.287 17.288C4.09567 17.4793 4 17.7167 4 18C4 18.2833 4.09567 18.5207 4.287 18.712Z"
                        fill={
                            fill
                                ? fill === true
                                    ? "currentcolor"
...
Icon.IconReturn = ({ size = "md", direction, fill }) => (
    <Svg
        $width={setSize(size)}
        $style={setDirection(direction)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Return?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconAtmosphere = ({ size = "md", fill }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Atmosphere?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconAlarmStatus = ({ size = "md", fill }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.AlarmStatus?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconPhone = ({ size = "md", fill }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Phone?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconFlood= ({ size = "md", fill, isFill = false, ...props }) => {
    return (
        <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
            {isFill ? (
                <path
                    d="M2 22V20C2.63333 20 3.10417 19.8333 3.4125 19.5C3.72083 19.1667 4.36667 19 5.35 19C6.33333 19 6.975 19.1667 7.275 19.5C7.575 19.8333 8.04167 20 8.675 20C9.30833 20 9.775 19.8333 10.075 19.5C10.375 19.1667 11.0167 19 12 19C12.95 19 13.5958 19.1667 13.9375 19.5C14.2792 19.8333 14.75 20 15.35 20C15.9833 20 16.45 19.8333 16.75 19.5C17.05 19.1667 17.6917 19 18.675 19C19.6583 19 20.3 19.1667 20.6 19.5C20.9 19.8333 21.3667 20 22 20V22C21.0333 22 20.3917 21.8333 20.075 21.5C19.7583 21.1667 19.2917 21 18.675 21C18.0583 21 17.5917 21.1667 17.275 21.5C16.9583 21.8333 16.3167 22 15.35 22C14.3833 22 13.7375 21.8333 13.4125 21.5C13.0875 21.1667 12.6167 21 12 21C11.3667 21 10.9 21.1667 10.6 21.5C10.3 21.8333 9.65833 22 8.675 22C7.69167 22 7.05 21.8333 6.75 21.5C6.45 21.1667 5.98333 21 5.35 21C4.73333 21 4.26667 21.1667 3.95 21.5C3.63333 21.8333 2.98333 22 2 22ZM2 17.5V15.5C2.63333 15.5 3.1 15.3333 3.4 15C3.7 14.6667 4.34167 14.5 5.325 14.5C5.425 14.5 5.525 14.5042 5.625 14.5125C5.725 14.5208 5.81667 14.5333 5.9 14.55L4.95 11.05L3.575 12.85L2 11.6L9.775 2L21.3 6.4L20.575 8.275L18.475 7.425L20.5 14.95C20.7333 15.0833 20.9625 15.2083 21.1875 15.325C21.4125 15.4417 21.6833 15.5 22 15.5V17.5C21.05 17.4833 20.4083 17.3125 20.075 16.9875C19.7417 16.6625 19.275 16.5 18.675 16.5C18.0417 16.5 17.575 16.6667 17.275 17C16.975 17.3333 16.3333 17.5 15.35 17.5C14.4 17.5 13.7542 17.3333 13.4125 17C13.0708 16.6667 12.6 16.5 12 16.5C11.3667 16.5 10.9 16.6667 10.6 17C10.3 17.3333 9.65833 17.5 8.675 17.5C7.725 17.5 7.08333 17.3333 6.75 17C6.41667 16.6667 5.95 16.5 5.35 16.5C4.76667 16.5 4.3 16.6667 3.95 17C3.6 17.3333 2.95 17.5 2 17.5ZM15.45 15.475L14.05 10.175L10.175 11.2L11.1 14.6C11.2333 14.5667 11.3708 14.5417 11.5125 14.525C11.6542 14.5083 11.8167 14.5 12 14.5C12.95 14.5 13.6292 14.6833 14.0375 15.05C14.4458 15.4167 14.9167 15.5583 15.45 15.475Z"
                    fill={
                        fill
                            ? fill === true
                                ? "currentcolor"
                ...
                <path
                    d="M2 22V20C2.63333 20 3.10417 19.8333 3.4125 19.5C3.72083 19.1667 4.36667 19 5.35 19C6.33333 19 6.975 19.1667 7.275 19.5C7.575 19.8333 8.04167 20 8.675 20C9.30833 20 9.775 19.8333 10.075 19.5C10.375 19.1667 11.0167 19 12 19C12.95 19 13.5958 19.1667 13.9375 19.5C14.2792 19.8333 14.75 20 15.35 20C15.9833 20 16.45 19.8333 16.75 19.5C17.05 19.1667 17.6917 19 18.675 19C19.6583 19 20.3 19.1667 20.6 19.5C20.9 19.8333 21.3667 20 22 20V22C21.0333 22 20.3917 21.8333 20.075 21.5C19.7583 21.1667 19.2917 21 18.675 21C18.0583 21 17.5917 21.1667 17.275 21.5C16.9583 21.8333 16.3167 22 15.35 22C14.3833 22 13.7375 21.8333 13.4125 21.5C13.0875 21.1667 12.6167 21 12 21C11.3667 21 10.9 21.1667 10.6 21.5C10.3 21.8333 9.65833 22 8.675 22C7.69167 22 7.05 21.8333 6.75 21.5C6.45 21.1667 5.98333 21 5.35 21C4.73333 21 4.26667 21.1667 3.95 21.5C3.63333 21.8333 2.98333 22 2 22ZM8.675 17.5C7.725 17.5 7.08333 17.3333 6.75 17C6.41667 16.6667 5.95 16.5 5.35 16.5C4.76667 16.5 4.3 16.6667 3.95 17C3.6 17.3333 2.95 17.5 2 17.5V15.5C2.63333 15.5 3.1 15.3333 3.4 15C3.7 14.6667 4.34167 14.5 5.325 14.5C5.425 14.5 5.525 14.5042 5.625 14.5125C5.725 14.5208 5.81667 14.5333 5.9 14.55L4.95 11.05L3.575 12.85L2 11.6L9.775 2L21.3 6.4L20.575 8.275L18.475 7.425L20.5 14.95C20.7333 15.0833 20.9625 15.2083 21.1875 15.325C21.4125 15.4417 21.6833 15.5 22 15.5V17.5C21.05 17.4833 20.4083 17.3125 20.075 16.9875C19.7417 16.6625 19.275 16.5 18.675 16.5C18.0417 16.5 17.575 16.6667 17.275 17C16.975 17.3333 16.3333 17.5 15.35 17.5C14.4 17.5 13.7542 17.3333 13.4125 17C13.0708 16.6667 12.6 16.5 12 16.5C11.3667 16.5 10.9 16.6667 10.6 17C10.3 17.3333 9.65833 17.5 8.675 17.5ZM8.675 15.5C9.175 15.5 9.5625 15.3833 9.8375 15.15C10.1125 14.9167 10.5333 14.7333 11.1 14.6L10.175 11.2L14.05 10.175L15.45 15.475C15.9667 15.4417 16.375 15.2875 16.675 15.0125C16.975 14.7375 17.5167 14.575 18.3 14.525L16.15 6.5L10.425 4.4L6.5 9.1L8.225 15.45C8.29167 15.4667 8.3625 15.4792 8.4375 15.4875C8.5125 15.4958 8.59167 15.5 8.675 15.5Z"
                    fill={
                        fill
                            ? fill === true
                                ? "currentcolor"
...
Icon.IconSOP = ({ size = "md", fill, isFill = true, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.SOP({ isFill })?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconPlus = ({ size = "md", fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Plus?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconCancel = ({ size = "md", fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Cancel?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconHome = ({ size = "md", fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Home?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconCapture = ({ size = "md", fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Capture?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconRotate = ({ size = "md", isActive, fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Rotate({ isActive })?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconDistanceMeasure = ({ size = "md", fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.DistanceMeasure?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconKeyMap = ({ size = "md", fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.KeyMap?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconCalendar = ({ size = "md", fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Calendar?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconTask = ({ size = "md", fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Task?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconPlay = ({ size = "md", isActive, fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {activeIcons.Play({ isActive })?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconPause = ({ size = "md", fill, ...props }) => (
    <Svg
        $width={setSize(size)}
        viewBox="0 0 24 24"
    >
        {defaultIcons.Pause?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconSun = ({ size = "md", fill, isFill = false, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Sun({ isFill })?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.IconWater = ({ size = "md", fill, isFill = false, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Water({ isFill })?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
const IconNaturalCCTV = ({ size = "md", fill, ...props }) => {
    return (
        <Svg
            $width={setSize(size)}
            viewBox="0 0 24 24"
            {...props}
        >
            <mask id="path-1-inside-1_4655_4690" fill="white">
                <path d="M8.09473 14.3398C8.91286 14.3398 9.73468 14.5301 10.4707 14.8906L13.5391 16.3936L13.5537 16.3867L21.9961 20.5215V22.0029H2V18.2666L4.21289 15.9834C5.22497 14.9391 6.63974 14.3399 8.09473 14.3398ZM17.8662 14.9941C19.2742 14.9942 20.6608 15.471 21.7705 16.3369L21.9961 16.5137V19.2168L14.8857 15.7344L15.0752 15.6416C15.9393 15.2184 16.9047 14.9941 17.8662 14.9941ZM20.8857 7.0625C20.8857 9.78471 18.6662 11.9999 
156ZM10.1465 4.10156V2.10156C11.1591 2.10156 11.9971 2.91927 12 3.95049L10 3.95605L8.00001 3.96162C8.00332 5.15368 8.97284 6.10156 10.1465 6.10156V4.10156ZM10 3.95605H12V2.14648H10H8V3.95605H10ZM10 2.14648H12C12 3.16999 11.1708 4 10.1465 4V2V0C8.9608 0 8 0.961757 8 2.14648H10ZM10.1465 2V4H21.7314V2V0H10.1465V2Z"
                fill={
                    fill
                        ? fill === true
                            ? "currentcolor"
                ...
                mask="url(#path-1-inside-1_4655_4690)"
            />
        </Svg>
    );
};

Icon.IconNaturalCCTV = IconNaturalCCTV;

const IconTrafficCCTV = ({ size = "md", fill, ...props }) => {
    return (
        <Svg
            $width={setSize(size)}
            viewBox="0 0 24 24"
        ...
        >
            <path
                d="M6.07812 20.8418C6.17989 21.2672 6.36691 21.66 6.62109 22H2V20.8418H6.07812ZM9.38867 18.1123C10.3713 18.2122 11.1377 19.0428 11.1377 20.0518L11.1279 20.251C11.0279 21.2333 10.1982 21.9998 9.18945 22L8.99023 21.9902C8.07316 21.8971 7.34337 21.168 7.25 20.251L7.24023 20.0518C7.24023 18.9755 8.11329 18.1027 9.18945 18.1025L9.38867 18.1123ZM22 22H11.7061C11.9602 21.66 12.1473 21.2673 12.249 20.8418L22 20.8281V22ZM9.18945 19.1025C8.66558 19.1027 8.24023 19.5278 8.24023 20.0518C8.24057 20.5754 8.66578 20.9998 9.18945 21C9.7132 20.9998 10.1374 20.5754 10.1377 20.0518C10.1377 19.5278 9.71333 19.1027 9.18945 19.1025ZM12.2158 14.9854C13.2091 14.9854 14.063 15.5955 14.4209 16.4609H12.8174V17.6328H14.6006V19.6699H12.3066C12.0944 18.1249 10.7664 16.9309 9.16406 16.9307C7.56152 16.9307 6.23281 18.1248 6.02051 19.6699H2V14.9854H12.2158ZM9.3916 13.8135H2V10.5459H7.39258L9.3916 13.8135ZM20.8857 7.0625C20.8857 9.78471 18.6662 11.9999 15.9385 12C13.2106 12 10.9912 9.78476 10.9912 7.0625V4.97949H20.8857V7.0625ZM15.9385 6.44238C14.7448 6.44238 13.7735 7.41343 13.7734 8.60645C13.7734 9.79951 14.7447 10.7705 15.9385 10.7705C17.1322 10.7704 18.1035 9.79945 18.1035 8.60645C18.1035 7.41349 17.1321 6.44247 15.9385 6.44238ZM15.9385 7.32031C16.6483 7.32031 17.2266 7.89707 17.2266 8.60645C17.2266 9.31586 16.6483 9.89258 15.9385 9.89258C15.2289 9.89231 14.6514 9.31569 14.6514 8.60645C14.6514 7.8972 15.2289 7.32058 15.9385 7.32031ZM15.9385 8.02148C15.6156 8.02175 15.3535 8.28365 15.3535 8.60645C15.3535 8.92925 15.6156 9.19114 15.9385 9.19141C16.2616 9.19141 16.5244 8.92941 16.5244 8.60645C16.5244 8.28349 16.2616 8.02148 15.9385 8.02148ZM21.7314 2C21.8121 2 21.8779 2.06588 21.8779 2.14648V3.95605C21.8777 4.03647 21.812 4.10156 21.7314 4.10156H10.1465C10.066 4.10156 10.0002 4.03647 10 3.95605V2.14648C10 2.06588 10.0658 2 10.1465 2H21.7314Z"
                fill={
                    fill
                        ? fill === true
                            ? "currentcolor"
...
Icon.IconTrafficCCTV = IconTrafficCCTV;

const IconWaterDisaster = ({ size = "md", fill, ...props }) => {
    return (
        <Svg
            $width={setSize(size)}
            viewBox="0 0 24 24"
        ...
        >
            <path
                d="M18 22C16.85 21.7167 15.8958 21.0542 15.1375 20.0125C14.3792 18.9708 14 17.8167 14 16.55V14L18 12L22 14V16.55C22 17.8167 21.6208 18.9708 20.8625 20.0125C20.1042 21.0542 19.15 21.7167 18 22ZM18 19.9C18.5833 19.6167 19.0625 19.1667 19.4375 18.55C19.8125 17.9333 20 17.2667 20 16.55V15.25L18 14.25V19.9Z"
                fill={
                    fill
                        ? fill === true
                            ? "currentcolor"
            ...
            />
            <path
                d="M12 19C12.1644 19 12.3196 19.0066 12.4658 19.0166C12.7497 19.7861 13.162 20.5203 13.7061 21.2178C13.8983 21.4642 14.1005 21.694 14.3096 21.9102C13.9014 21.8291 13.6017 21.6945 13.4121 21.5C13.0871 21.1668 12.6165 21 12 21C11.3667 21 10.8996 21.1667 10.5996 21.5C10.2995 21.8332 9.65795 22 8.6748 22C7.69158 22 7.04998 21.8333 6.75 21.5C6.45 21.1667 5.98294 21 5.34961 21C4.7332 21.0001 4.26679 21.1668 3.9502 21.5C3.63353 21.8333 2.98333 22 2 22V20C2.63321 20 3.10377 19.8332 3.41211 19.5C3.7204 19.1667 4.3665 19 5.34961 19C6.33294 19 6.97539 19.1667 7.27539 19.5C7.57537 19.8332 8.04169 20 8.6748 20C9.30814 20 9.7752 19.8333 10.0752 19.5C10.3752 19.1667 11.0168 19 12 19ZM21.2998 6.40039L20.5752 8.27539L18.4746 7.4248L19.335 10.623L18 10L17.1885 10.3779L16.1504 6.5L10.4248 4.40039L6.5 9.09961L8.22461 15.4502C8.29127 15.4669 8.36251 15.479 8.4375 15.4873C8.51244 15.4956 8.59154 15.5 8.6748 15.5C9.1748 15.5 9.56289 15.3837 9.83789 15.1504C10.1128 14.9171 10.5331 14.7329 11.0996 14.5996L10.1748 11.2002L14.0498 10.1748L14.4414 11.6592L12 12.7998V16.3701C12 16.4135 12.0013 16.4568 12.002 16.5H12C11.3667 16.5 10.8996 16.6667 10.5996 17C10.2995 17.3332 9.65795 17.5 8.6748 17.5C7.72491 17.5 7.08331 17.3333 6.75 17C6.41667 16.6667 5.94961 16.5 5.34961 16.5C4.76652 16.5001 4.30011 16.6668 3.9502 17C3.6002 17.3333 2.95 17.5 2 17.5V15.5C2.63333 15.5 3.10039 15.3333 3.40039 15C3.70047 14.6668 4.34205 14.5 5.3252 14.5C5.42513 14.5 5.52507 14.5044 5.625 14.5127C5.72499 14.521 5.81706 14.5331 5.90039 14.5498L4.9502 11.0498L3.5752 12.8496L2 11.5996L9.77539 2L21.2998 6.40039Z"
                fill={
                    fill
                        ? fill === true
                            ? "currentcolor"
...
Icon.IconWaterDisaster = IconWaterDisaster;
