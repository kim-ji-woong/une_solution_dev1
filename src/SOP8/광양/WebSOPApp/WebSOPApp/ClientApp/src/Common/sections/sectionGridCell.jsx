...
class SectionGridCell extends Component {
    ...
    makeSectionComponent(sectionData) {
        ...
        if (sectionData.component.compn_code === "process" || sectionData.component.compn_code === SectionData.ProcessType) {
        ...
        else if (sectionData.component.compn_code === "endpoint" || sectionData.component.compn_code === SectionData.EndpointType) {
        ...
        else if (sectionData.component.compn_code === "decision" || sectionData.component.compn_code === SectionData.DecisionType) {
        ...
        else if (sectionData.component.compn_code === "annotation" || sectionData.component.compn_code === SectionData.AnnotationType) {
        ...
        else if (sectionData.component.compn_code === "internal" || sectionData.component.compn_code === SectionData.InternalType) {
