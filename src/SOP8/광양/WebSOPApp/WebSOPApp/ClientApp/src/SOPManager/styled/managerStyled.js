...
export const SOPManagerBodyMainComponent = styled.div`
    ...
    .sopEdtTitle span.ylw {
        background: ${({ theme }) => theme.colors.warning.warning500};  
    }
    ...
    .sopEdtRdo2{
        display: block;
        padding-top: 10px;
        border-top: dashed 0.5px ${({ theme }) => theme.colors.grayscale.g700};
    ...
    .sopEdtCpnt{
        ...
        > li{
            margin-bottom: 10px;
            border-bottom: dashed 1px ${({ theme }) => theme.colors.grayscale.g700};
    ...
    .spcTop{
        ...
        > li{
            ...
            float: left;
            width: 25%;
            border-right: dashed 1px ${({ theme }) => theme.colors.grayscale.g700};
        }
        > li:last-child{
            border-right: none;
        }
    ...
    .sopTopCopy{
        ...
        height: 30px;
        line-height: 30px;
        background: ${({ theme }) => theme.colors.grayscale.g600};
        color: ${({ theme }) => theme.colors.primary.p500};
        font-size: 16px;
        margin-right: 4px;
        text-align: center;
