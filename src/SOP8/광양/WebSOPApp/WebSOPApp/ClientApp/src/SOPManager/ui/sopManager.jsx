...
class SopManager extends Component {
    ...
    constructor(props)
    {
        ...
        this.state = {
            selectedSiteNo: null,
            content: SopManagerResource.ID.menu.editSOP,
            menuDatas: null,
            showCascading:
            {
                actionStep: false,
    ...
    async saveDB(sopData) {
        ...
        for (const actionStepData of sopData.actionStepDatas) {
            ...
            for (const section of stepMember.sections) {
                ...
                if (component?.compn_code === SectionData.InternalType && transmission?.mssage === null) {
                    transmission.mssage = '';
                }
            }
        }
    ...
    getPopup() {
        if (this.state.content === SopManager.menu.open) {
            return <OpenSOPOptions sopData={this.state.sopData} content={this.changeContent} showConfirmDialog={this.showConfirmDialog} handleTooltip={this.handleTooltip} removeTooltip={this.removeTooltip} selectedSiteNo={this.state.selectedSiteNo} />;
        }
        else if (this.state.content === SopManager.menu.delete) {
            return <DeleteSOPOptions ref={this.deleteSOPOptionsRef} sopData={this.state.sopData} content={this.changeContent} showConfirmDialog={this.showConfirmDialog} onCloseConfirmDialog={this.onCloseConfirmDialog} handleTooltip={this.handleTooltip} removeTooltip={this.removeTooltip} selectedSiteNo={this.state.selectedSiteNo} />;
        }
