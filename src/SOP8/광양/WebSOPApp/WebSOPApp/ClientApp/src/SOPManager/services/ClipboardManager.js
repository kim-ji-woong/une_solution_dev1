...
export default class ClipboardManager {
	...
	static cloneSection(section, columnIndex, rowIndex) {
		...
		if (section.component.compn_code === SectionDataProcess.getComponentType() || section.component.compn_code === SectionData.ProcessType) {
			sectionData = new SectionDataProcess();
			SectionDataProcess.copyTo(section, sectionData);
		}
		else if (section.component.compn_code === SectionDataDecision.getComponentType() || section.component.compn_code === SectionData.DecisionType) {
			sectionData = new SectionDataDecision();
			SectionDataDecision.copyTo(section, sectionData);
		}
		else if (section.component.compn_code === SectionDataAnnotation.getComponentType() || section.component.compn_code === SectionData.AnnotationType) {
			sectionData = new SectionDataAnnotation();
			SectionDataAnnotation.copyTo(section, sectionData);
		}
		else if (section.component.compn_code === SectionDataEndpoint.getComponentType() || section.component.compn_code === SectionData.EndpointType) {
			sectionData = new SectionDataEndpoint();
			SectionDataEndpoint.copyTo(section, sectionData);
		}
		else if (section.component.compn_code === SectionDataInternal.getComponentType() || section.component.compn_code === SectionData.InternalType) {
			sectionData = new SectionDataInternal();
			SectionDataInternal.copyTo(section, sectionData);
		}

		if (sectionData) {
			sectionData.component.column_no = columnIndex;
