									...
									<dl className={'sprmAcdn'}>
										...
										<dd className={this.getReceiversClassName()}>
											<div className={'sprmRadioBox'}>
												<span><label><input type="radio" name="team" checked={this.state.teamType === Receiver.RegularTeam} onChange={() => this.onChangeTeamMode(Receiver.RegularTeam)} />정규조직</label></span>
												<span><label><input type="radio" name="team" checked={this.state.teamType === Receiver.TemporaryNormalTeam} onChange={() => this.onChangeTeamMode(Receiver.TemporaryNormalTeam)} />평일 비상조직</label></span>
												<span><label><input type="radio" name="team" checked={this.state.teamType === Receiver.TemporaryEmergencyTeam} onChange={() => this.onChangeTeamMode(Receiver.TemporaryEmergencyTeam)} />야간/휴일 비상조직</label></span>
											</div>
