										...
										<div className={'speGry'}>
											{
												disasterCategories.map(disasterCategoryData => (
													<li key={"dc_" + disasterCategoryData.disasterCategory.lclas_sn + "_" + disasterCategoryData.disasterCategory.lclas_name}>
										...
										<div className={'speLst'}>
											{
												subDisasterCategories.map(sdc => (
													<li key={"sdc_" + sdc.subDisasterCategory.mclas_sn + "_" + sdc.subDisasterCategory.mclas_name}>
