    ...
    *:focus {
    ...
    input:-webkit-autofill:active {
        -webkit-box-shadow: 0 0 0 1000px ${({ theme }) =>
            theme.colors.background.surface} inset !important;
        box-shadow: 0 0 0 1000px ${({ theme }) =>
            theme.colors.background.surface} inset !important;

        -webkit-text-fill-color: ${({ theme }) =>
            theme.colors.grayscale.g100} !important;

        background-color: ${({ theme }) =>
            theme.colors.background.surface} !important;
    ...
    input[type=checkbox]:checked {
        ...
        background: ${({ theme }) => theme.colors.primary.p500} url(${check_mark_checked}) no-repeat center center;
    }
