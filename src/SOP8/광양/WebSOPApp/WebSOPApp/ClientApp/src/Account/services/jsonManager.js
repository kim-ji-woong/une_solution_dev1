export class JsonManager {
    ...
    // sortType : 정렬 기준 컬럼 선택값 (예: 0=멤버명, 1=사용자 ID, 2=등급)
    // sortMethod : 정렬 방향 선택값 (true=ASC, false=DESC)
    static makeRequestUserList(searchText, pageNo, pageRowCount, useTeamName, useMemberName, useNickName, useJobLevel, useJobPosition, useGrade, usePhoneNumber, useEmail, siteNo, sortType = null, sortMethod = true) {
        const json = {
