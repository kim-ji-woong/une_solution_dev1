...
function EventDashboard(props) {
    ...
    }, [moveDisplayAlarm, props.spreadAlarm, props.sensorAlarms]);
    ...
    const openTargetAlarm = () => {
        const onAlarms = props.sensorAlarms?.filter(alarm => alarm.isAlarm) || [];
        const targetAlarm = props.spreadAlarm || onAlarms[0];
        const targetZoneNo = props.spreadAlarm?.sensorZoneNo || onAlarms[0]?.sensorZoneNo;
