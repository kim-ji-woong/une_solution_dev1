...
export class SDMSDataManager {
            ...
            for (const zoneID in buildingZones) {
                ...
                if (equipmentZoneDatas) {
                    ...
                    for (let j = 0; j < equipZoneCount; j++) {
                        ...
                        equipZoneData.push(equipmentZoneData.equipZoneNo);
                        ...
                        zone.equipZones[equipmentZoneData.equipZoneNo] = equipZoneData;
                    }
                }
            }
        }
    ...
    static getZoneFloor(zone) {
        ...
        return zone.floorIndex + zone.floorIndex;
    }
