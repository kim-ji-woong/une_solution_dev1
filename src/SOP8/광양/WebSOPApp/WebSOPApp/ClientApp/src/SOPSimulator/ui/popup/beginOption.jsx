...
function BeginOption(props) {
    ...
    useEffect(() => {
        ...
        $('#sqpRdo01').click(function () {
            $('.sqpSelectBox').css({ background: '#121721' });
            ...
            <BeginOptionComponent id={'sopPop'} className='UI_Section'>
                ...
                <div className={'sqpCont'}>
                    ...
                    <div className={'sqpDown'}>
                        <ul className={'sqpRdo'}>
                            <li><label><input type="radio" name="sqpRdo" onChange={() => onChangeTimeMode(true)} checked={isCurrent} />현재 시간을 재난발생시간으로 설정</label></li>
                            <li><label><input type="radio" name="sqpRdo" onChange={() => onChangeTimeMode(false)} />재난발생 시간 입력</label></li>
                        </ul>
