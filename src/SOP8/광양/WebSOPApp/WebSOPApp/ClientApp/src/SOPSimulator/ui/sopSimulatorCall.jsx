                    ...
                    <div className={'sopTit clfix'}>
                        ...
                        <div className={'filterArea clfix'}>                                    
                            <div className={'allDaycheckBox'}>
                                <label>
                                    <input type="checkbox" name='isNormal' checked={isNormal} onChange={onChangeNormal}/>
                                    평일/주간
                                </label>
                            </div>
                            <div className={'holidayCheckBox cGreen'}>
                                <label>
                                    <input type="checkbox" name='isNormal' checked={isEmergency} onChange={onChangeEmergency}/>
                                    휴일/야간
                                </label>
                            </div>
                        </div>
