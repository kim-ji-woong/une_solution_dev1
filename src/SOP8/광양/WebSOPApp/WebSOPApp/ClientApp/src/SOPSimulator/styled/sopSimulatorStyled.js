...
import check_mark_checked from '../../Common/images/check_mark_checked.svg';
import iconLeftt from '../img/iconArrowLeft.svg'
import iconPlus from '../img/iconPlus.svg'
import iconArrowLeft from '../img/iconArrowLeft.svg'
import iconMod from '../img/sopEditIcon.svg'
import iconPlay from '../img/sopPlayIcon.svg'
import iconEnd from '../img/sopOutIcon.svg'
...
export const SopSimulatorBodyComponent = styled.section`
    ...
    .tabArea li a.plus {
        ...
        border-radius: 5px;  
        cursor:pointer;
        background: ${({ theme }) => theme.colors.background.overlay} url(${iconPlus}) no-repeat; 
    ...
    .leftt { 
        width: 50%;  
        background: ${({ theme }) => theme.colors.background.overlay} url(${iconLeftt}); 
        background-repeat: no-repeat; 
        background-position: center; 
        border: solid 1px ${({ theme }) => theme.colors.primary.p500};
        border-radius: 3px;
...
export const SopSimulatorCallComponent = styled.section`
    ...
    .appContainer{
        height: 100%;
        padding: 25px 39px;
        ${({ theme }) => theme.mixins.flex('center', 'center', 'row', '18px')};
    }
    ...
    .boardListWrap .filterArea .cGreen { 
        ...
        input[type=checkbox]:active {
            border: 1px solid #805AD5;
            background: transparent url(${check_mark}) no-repeat center center; 
        }

        input[type=checkbox]:checked {
            border: 1px solid #805AD5;
            background: #805AD5 url(${check_mark_checked}) no-repeat center center;
        }
    }
    ...
    input[type=radio]:checked {
        border: solid 1.5px ${({ theme }) => theme.colors.primary.p500} !important;
    }
    ...
    #filter02:checked {
        background: url(${check_mark_holiday}) no-repeat center center; 
    }
`;
...
export const SopSimulatorChartComponent = styled.div`
    ...
    .class4th.unActive button {
        background-color: ${({ theme }) => theme.colors.error.error700}; 
        color: ${({ theme }) => theme.colors.grayscale.g200};
        cursor: pointer;
        opacity: 0.5;
        border: none; 
    ...
    .class2nd.isActive button {
        background-color: ${({ theme }) => theme.colors.warning.warning500};  
        color: ${({ theme }) => theme.colors.white};
        border: none; 
        cursor:pointer; 
    }
    ...
    .class4th.isActive button {
        background-color: ${({ theme }) => theme.colors.error.error500};  
        color: ${({ theme }) => theme.colors.white};
        border: none; 
        cursor:pointer; 
    }
