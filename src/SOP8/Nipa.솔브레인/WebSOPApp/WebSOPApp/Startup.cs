    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            if (m_configManager.Site.DBType != null)
            {
                ...
                string strWebAPIServerURL = m_configManager.Site.WebAPIServerURL;
                ...
                services.AddTransient<Base.Account.IBLL.Interface.IUserCreator>(service => new Agent.Soulbrain.UserCreator());
                ...
                services.AddTransient<Soulbrain.BLL.Process.WishManager>(service => new Soulbrain.BLL.Process.WishManager(strWebAPIServerURL));
            }
        }
