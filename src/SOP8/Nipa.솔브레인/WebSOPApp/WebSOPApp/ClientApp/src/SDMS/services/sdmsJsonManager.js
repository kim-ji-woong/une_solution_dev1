export class SdmsJsonManager {   
    ...
    static makeRequestFacilityModelList() {
        const json = {
        };
    ...
    static makeRequestSimulationPoi() {
        const json = {
        };
    ...
    static makeRequestScannerInfo(scannerId) {
        const json = {
            "scannerSn": scannerId
        };
    ...
    static makeRequestScannerTagInfo(sensorZoneHistoryNo) {
        const json = {
            "sensorZoneHistoryNo": sensorZoneHistoryNo
        }
    ...
    static makeRequestScannerEmergencyInfo(sensorZoneHistoryNo) {
        const json = {
            "sensorZoneHistoryNo": sensorZoneHistoryNo
        }
