				...
				<div className={'scrollWrapperDecision'}>
					<div className={'sprmCont'}>
						<dl className={'sprmAcdn'}>
							<dt ref={this.refDescriptionDT} className={this.getDescriptionClassName()} onClick={this.onClickCascade}>
								판단 기준 설명
								<Icon.Arrow size="sm" direction={this.state.descriptionOn ? "top" : "bottom"} />
							</dt>
