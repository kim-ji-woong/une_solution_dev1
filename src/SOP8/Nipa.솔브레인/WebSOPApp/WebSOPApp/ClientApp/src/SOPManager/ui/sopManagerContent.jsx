				...
				<div className={'aslWrap' + " " + 'typeC'}>
					<div className={'salMenu' + " " + 'on'}>
						<div className={'salCont'}>
							<dd><span className={'newSOPIcon'} onClick={(e) => {if (props.menu !== SopManagerResource.menu.newSOP) {onClickMenu(e.target)}}}>{SopManagerResource.menu.newSOP}</span></dd>
							<dd><div className='line' /></dd>
							<dd><span className={'sopOpenIcon'} onClick={(e) => {if (props.menu !== SopManagerResource.menu.newSOP) {onClickMenu(e.target)}}}>{SopManagerResource.menu.open}</span></dd>
							<dd><span className={'sopOpenXMLIcon'} onClick={(e) => {if (props.menu !== SopManagerResource.menu.newSOP) {onClickMenu(e.target)}}}>{SopManagerResource.menu.openXML}</span></dd>
							<dd><div className='line' /></dd>
							<dd><span className={'sopDeleteIcon'} onClick={(e) => {if (props.menu !== SopManagerResource.menu.newSOP) {onClickMenu(e.target)}}}>{SopManagerResource.menu.delete}</span></dd>
							<dd><div className='line' /></dd>
							<dd><span className={'sopSaveIcon'} onClick={(e) => {if (props.menu !== SopManagerResource.menu.newSOP) {onClickMenu(e.target)}}}>{SopManagerResource.menu.save}</span></dd>
							<dd><span className={'sopSaveXMLIcon'} onClick={(e) => {if (props.menu !== SopManagerResource.menu.newSOP) {onClickMenu(e.target)}}}>{SopManagerResource.menu.saveXML}</span></dd>
							{/* <dd><SopSaveAsIcon onClick={(e) => {if (props.menu !== SopManagerResource.menu.newSOP) {onClickMenu(e.target)}}}>{SopManagerResource.menu.save}</SopSaveAsIcon></a></dd> */}
						</div>
					</div>
				</div>
			</div>
