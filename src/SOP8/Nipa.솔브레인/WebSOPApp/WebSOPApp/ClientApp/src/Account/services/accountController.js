...
export class AccountController {
    ...
    static async requestAllSite() {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/RequestAllSite', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestUserList(searchText, pageNo, pageRowCount, useTeamName = true, useMemberName = true, useNickName = true, useJobLevel = true, useJobPosition = true, useGrade = true, usePhoneNumber = true, useEmail = true, siteNo = null) {
        try {
            const jsonData = JsonManager.makeRequestUserList(searchText, pageNo, pageRowCount, useTeamName, useMemberName, useNickName, useJobLevel, useJobPosition, useGrade, usePhoneNumber, useEmail, siteNo);

            const res = await fetch(ProjectResource.baseUrl + '/api/Account/RequestUserList', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestGradeList() {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/RequestGradeList', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async updateUserInfo(userNo, nickName = null, grade = null, memo = null) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/UpdateUserInfo', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async deleteUser(userNo) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/DeleteUser', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async createUser(userID, userNickName, grade, regularMemberNo = null, memo = null, siteNo = null) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/CreateUser', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async checkValidPassword(password) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/RequestPasswordPolicy', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
            ...
            if (res.ok) {
                ...
                if (result.success) {
                    ...
                    if (success === false) {
                        return [false, "영문 대소문자와 숫자 또는 특수문자 (_,-) 조합으로 5~10자로 입력하세요."];
                    }
    ...
    static async setPassword(userNo, userID, pwd, newPwd) {
        ...
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/RequestChangePassword', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestTemporaryPasswordWithSMS(userName, phoneNumber) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/RequestTemporaryPasswordWithSMS', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestTemporaryPasswordWithEmail(userName, email) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/RequestTemporaryPasswordWithEmail', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestSaveOptions(userNo, options) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/SaveOptions', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestOptions(userNo, category = null, subCategory = null) {
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/RequestOptions', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestLoginKey(userID) {
        ...
        try {
            ...
            const res = await fetch(ProjectResource.baseUrl + '/api/Account/LoginKey2', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
