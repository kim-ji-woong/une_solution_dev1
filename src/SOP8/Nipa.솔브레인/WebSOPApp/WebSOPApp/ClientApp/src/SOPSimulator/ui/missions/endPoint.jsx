...
function EndPoint(props) {
    ...
    if (!props.sectionData.endpoint.begin_yn &&
        props.currentSection && SectionData.isEndpointType(props.currentSection.component.compn_code) && props.currentSection.endpoint.begin_yn) {
    ...
    return (
        <EndPointComponent className={'sectionBox round' + boxClassName} id={props.id}>
            <div className={'tit clfix' + " " + 'sectionBoxStart' + textClassName}>
                ...
                <div className={'btnArea btnArea'}>
                    <a className={btnNextClassName} onClick={runSection} title={props.sectionData.endpoint.title}>{props.sectionData.endpoint.begin_yn ? "시작" : "종료"}</a>
                </div>
            </div>
        </EndPointComponent>
    );
