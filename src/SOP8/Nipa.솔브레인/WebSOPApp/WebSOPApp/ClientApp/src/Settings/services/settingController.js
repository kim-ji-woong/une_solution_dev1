...
export class SettingController {
    ...
    // requestDatas : [{categoryName, propertyName}]
    static async requestSettingList(siteNo, requestDatas) {
        try {
            const jsonData = JsonManager.makeRequestSettingList(siteNo, requestDatas);

            const res = await fetch('api/Settings/RequestSettingList', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
        ...
        return [null, "requestSettingList 실패"];
    }
    ...
    // detectTypes : {300400: "신호탐지", 300401: "재난신고", 300402: "복구신호"}
    ...
    // detectType : -1이면 모든 타입(300400 : 신호탐지, 300401 : 재난신고, 300402 : 복구신호)
    ...
    static async requestGetSpreadMessage(sensorType = -1, sensorSubType = null, messageType = -1, detectType = -1, isActive = null, buildingGroupNo = null, buildingNo = null, zoneNo = null, searchText = null, pageIndex = null, pageItemCount = null, searchTextTypes = null, sensorTypeDatas = null) {
        try {
            const jsonData = JsonManager.makeRequestGetSpreadMessage(sensorType, sensorSubType, messageType, detectType, isActive, buildingGroupNo, buildingNo, zoneNo, searchText, pageIndex, pageItemCount, searchTextTypes, sensorTypeDatas);
    ...
    // detectType : (300400 : 신호탐지, 300401 : 재난신고, 300402 : 복구신호)
    ...
    static async requestDownloadBuildingGroup(selectedSiteNo) {
        try {
            const jsonData = JsonManager.makeRequestDownloadBuildingGroup(null, selectedSiteNo);

            const res = await fetch('api/Settings/DownloadBuildingGroupData', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestDownloadBuilding(selectedSiteNo) {
        try {
            const jsonData = JsonManager.makeRequestDownloadBuilding(null, selectedSiteNo);

            const res = await fetch('api/Settings/DownloadBuildingData', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestDownloadFacility(selectedSiteNo) {
        try {
            ...
            const res = await fetch('Settings/Settings/DownloadFacilityData', {
                method: 'post',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json'
    ...
    static async requestUploadBuildingGroupFile(file, siteNo) {
        try {
            const formData = new FormData();
            formData.append('files', file);
            formData.append('siteNo', siteNo);

            const res = await fetch('api/Settings/UploadBuildingGroupData', {
                method: 'post',
                body: formData
            });
    ...
    static async requestUploadBuildingFile(file, siteNo) {
        try {
            const formData = new FormData();
            formData.append('files', file);
            formData.append('siteNo', siteNo);

            const res = await fetch('api/Settings/UploadBuildingData', {
                method: 'post',
                body: formData
            });
    ...
    static async requestUploadFacilityFile(file, siteNo) {
        try {
            const formData = new FormData();
            formData.append('files', file);
            formData.append('siteNo', siteNo);

            const res = await fetch('Settings/Settings/UploadFacilityData', {
                method: 'post',
                body: formData
            });
