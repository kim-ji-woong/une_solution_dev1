...
class SectionPanel extends Component {
    ...
    componentDidUpdate(prevProps) {
        // sopData가 변경되었을 경우 스크롤을 맨 위로 이동시킨다.
        if (prevProps.sopData !== this.props.sopData) {
            if (this.refPanel.current) {
                this.refPanel.current.scrollTop = 0;
                this.refPanel.current.scrollLeft = 0;
            }
        }
