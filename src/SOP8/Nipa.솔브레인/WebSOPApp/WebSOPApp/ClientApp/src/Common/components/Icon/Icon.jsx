...
Icon.IconMove = ({ size = "md", fill, ...props }) => (
    <Svg $width={setSize(size)} viewBox="0 0 24 24" {...props}>
        {defaultIcons.Move?.map((i, key) => (
            <path
                key={key}
                d={i}
                fill={
...
Icon.SortIcon = ({ fill, direction }) => {
    return(
        <Svg
            width="16" height="10" viewBox="0 0 16 10"
            $style={setDirection(direction)}
        >
            <path id="Vector" fillRule="evenodd" clipRule="evenodd" d="M2.67058 7.56129L1.6338 6.63774L0.5 7.64772L2.90552 9.79054C3.21823 10.0698 3.7266 10.0698 4.03932 9.79054L6.44483 7.64772L5.31103 6.63774L4.27426 7.56129V9.53674e-07H2.67058V7.56129ZM7.48161 8.57128H15.5V7.14273H7.48161V8.57128ZM7.48161 5.71418H15.5V4.28564H7.48161V5.71418ZM7.48161 2.85709H15.5V1.42855H7.48161V2.85709Z"
            fill={
                    fill
                        ? fill === true
                            ? "currentcolor"
