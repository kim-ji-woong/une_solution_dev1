...
class SectionGridCell extends Component {
    ...
    makeSectionData(menuType) {
        ...
        sectionData.component.column_no = this.props.columnIndex;
        sectionData.component.row_no = this.props.index;
        return sectionData;
    }
    ...
    makeSectionComponent(sectionData) {
        ...
        if (this.props.selectedSectionData) {
            if (this.props.selectedSectionData.component.row_no === this.props.index && this.props.selectedSectionData.component.column_no === this.props.columnIndex) {
                isSelected = true;
            }
        }
        ...
        if (SectionData.isProcessType(sectionData.component.compn_code)) {
            return <Process parentCell={this.refCell} onClickArrowButton={this.onClickArrowButton} onClickComponent={this.onClickComponent} sectionData={sectionData} isSelected={isSelected} selectedSectionData={this.props.selectedSectionData} mode={this.props.mode} status={status} drawingAreaRect={this.props.drawingAreaRect} />;
        }
        else if (SectionData.isEndpointType(sectionData.component.compn_code)) {
            return <Endpoint parentCell={this.refCell} onClickArrowButton={this.onClickArrowButton} onClickComponent={this.onClickComponent} sectionData={sectionData} isSelected={isSelected} selectedSectionData={this.props.selectedSectionData} mode={this.props.mode} status={status} drawingAreaRect={this.props.drawingAreaRect} />;
        }
        else if (SectionData.isDecisionType(sectionData.component.compn_code)) {
            return <Decision parentCell={this.refCell} onClickArrowButton={this.onClickArrowButton} onClickComponent={this.onClickComponent} sectionData={sectionData} isSelected={isSelected} selectedSectionData={this.props.selectedSectionData} mode={this.props.mode} status={status} drawingAreaRect={this.props.drawingAreaRect} />;
        }
        else if (SectionData.isAnnotationType(sectionData.component.compn_code)) {
            return <Annotation parentCell={this.refCell} onClickArrowButton={this.onClickArrowButton} onClickComponent={this.onClickComponent} sectionData={sectionData} isSelected={isSelected} selectedSectionData={this.props.selectedSectionData} mode={this.props.mode} status={status} drawingAreaRect={this.props.drawingAreaRect} />;
        }
        else if (SectionData.isTransmissionType(sectionData.component.compn_code)) {
            return <Internal parentCell={this.refCell} onClickArrowButton={this.onClickArrowButton} onClickComponent={this.onClickComponent} sectionData={sectionData} isSelected={isSelected} selectedSectionData={this.props.selectedSectionData} mode={this.props.mode} status={status} drawingAreaRect={this.props.drawingAreaRect} />;
        }
    ...
    render() {
        ...
        const addClassName = this.props.isSelected ? " " + "selected" : "";
