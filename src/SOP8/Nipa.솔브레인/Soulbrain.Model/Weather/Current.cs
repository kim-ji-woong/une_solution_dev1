...
namespace Soulbrain.Model.Weather
{
	public class Current : Table
	{
		public enum Fields { wethr_site_sn, tp, sensb_tp, rain, rain_per_hr, hd, wind_spd, atm, updt_tm, wethr_sttus_optn_code, wethr_sttus_code, wind_drc_optn_code, wind_drc_code };
		public enum WriteFields { wethr_site_sn, tp, sensb_tp, rain, rain_per_hr, hd, wind_spd, atm, updt_tm, wethr_sttus_optn_code, wethr_sttus_code, wind_drc_optn_code, wind_drc_code };

		public int wethr_site_sn { get; set; }
		public double tp { get; set; }
		public double? sensb_tp { get; set; }
		public double rain { get; set; }
		public double? rain_per_hr { get; set; }
		...
		public void FromCopy(Current obj)
		{
			...
			this.rain = obj.rain;
			this.rain_per_hr = obj.rain_per_hr;
			this.hd = obj.hd;
