...
{
	public class WeatherCurrent : Table
	{
		...
		public WeatherCurrent(int weatherSIteNo, int state, double temperature, double? sensibleTemperature, double rain, double humidity, double? windSpeed, int windDirection, double? atm, DateTime dtUpdate)
        {
