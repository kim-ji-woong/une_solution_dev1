...
namespace dnsDapperDBUtil.Manager
{
    public class MySqlManager : DBManager
    {
        ...
        public static DbConnection GetConnection(string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner = null)
        {
        ...
        public static bool Excute(string query, object param, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            try
            {
                if (transactionOwner == null)
                {
                    using (MySqlConnection connection = GetConnection(strDbHost, strDbName, strDbID, strDbPw) as MySqlConnection)
                    {
        ...
        public static bool Excute(List<QueryParamSet> querySet, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            try
            {
        ...
        public static bool Insert<T>(string query, T t, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            try
            {
        ...
        public static bool Insert<T>(string query, T t, out int nAddID, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            nAddID = -1;
            try
        ...
        public static bool Insert<T>(string query, IEnumerable<T> t, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            try
            {
        ...
        public static T QueryFirst<T>(string query, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            try
            {
        ...
        public static IEnumerable<T> Query<T>(string query, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            try
            {
        ...
        public static IEnumerable<T> Query<T>(string query, object args, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            try
            {
        ...
        public static dynamic QueryFirst(string query, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            try
            {
        ...
        public static IEnumerable<dynamic> Query(string query, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg)
        {
            strErrMsg = null;
            try
            {
        ...
        public static IEnumerable<T3> Query<T1, T2, T3>(string query, T3 t3, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg) where T3 : IDataClass, new()
        {
            strErrMsg = null;
            try
            {
        ...
        public static List<T> QueryGeometry<T>(string strConditions, string strDbHost, string strDbName, string strDbID, string strDbPw, MySqlManager transactionOwner, out string strErrMsg) where T : DataAccessLayer.IDAL.Table, new()
        {
            strErrMsg = null;
            try
            {
        ...
        public static MySqlManager BeginTransaction(string strDBHost, string strDBName, string strDbID, string strDbPW, out string strErrMsg)
        {
            strErrMsg = null;
            string strConnection = GetConnectionString(strDBHost, strDBName, strDbID, strDbPW);
